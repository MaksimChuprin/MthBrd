...
RECT SCREEN = {0, RESOLUTION_X-1, 0, RESOLUTION_Y-1, BACKGROUND_COLOR};

RECT MENU0_LEFT  = {LEFT_COLUMN_SX,  LEFT_COLUMN_EX,  0,   119, EVEN_YELLOW};
RECT MENU1_LEFT  = {LEFT_COLUMN_SX,  LEFT_COLUMN_EX,  120, 239, EVEN_YELLOW};
RECT MENU2_LEFT  = {LEFT_COLUMN_SX,  LEFT_COLUMN_EX,  240, 359, EVEN_YELLOW};
RECT MENU3_LEFT  = {LEFT_COLUMN_SX,  LEFT_COLUMN_EX,  360, 479, EVEN_YELLOW};

RECT MENU0_RIGHT = {RIGHT_COLUMN_SX, RIGHT_COLUMN_EX, 0,   119, EVEN_YELLOW};
RECT MENU1_RIGHT = {RIGHT_COLUMN_SX, RIGHT_COLUMN_EX, 120, 239, EVEN_YELLOW};
RECT MENU2_RIGHT = {RIGHT_COLUMN_SX, RIGHT_COLUMN_EX, 240, 359, EVEN_YELLOW};
RECT MENU3_RIGHT = {RIGHT_COLUMN_SX, RIGHT_COLUMN_EX, 360, 479, EVEN_YELLOW};

const RECT RIGHT_DUMMY = {RIGHT_COLUMN_SX, RIGHT_COLUMN_EX, UPPER_LINE_SY, LOWERMOST_LINE_EY, EVEN_YELLOW};

RECT UPPERMOST  = {0, RESOLUTION_X-1, UPPERMOST_LINE_SY, UPPERMOST_LINE_EY, RED};
RECT UPPER      = {0, RESOLUTION_X-1, UPPER_LINE_SY,     UPPER_LINE_EY,     RED};
RECT MIDDLE     = {0, RESOLUTION_X-1, MIDDLE_LINE_SY,    MIDDLE_LINE_EY,    RED};
RECT LOWER      = {0, RESOLUTION_X-1, LOWER_LINE_SY,     LOWER_LINE_EY,     RED};
RECT LOWERMOST  = {0, RESOLUTION_X-1, LOWERMOST_LINE_SY, LOWERMOST_LINE_EY, RED};

RECT UPPERMOST_TOP      = {0, RESOLUTION_X-1, UPPERMOST_TOP_LINE_SY,    UPPERMOST_TOP_LINE_EY,    RED};
RECT UPPERMOST_BOTTOM   = {0, RESOLUTION_X-1, UPPERMOST_BOTTOM_LINE_SY, UPPERMOST_BOTTOM_LINE_EY, RED};
RECT UPPER_TOP          = {0, RESOLUTION_X-1, UPPER_TOP_LINE_SY,        UPPER_TOP_LINE_EY,        RED};
RECT UPPER_BOTTOM       = {0, RESOLUTION_X-1, UPPER_BOTTOM_LINE_SY,     UPPER_BOTTOM_LINE_EY,     RED};
RECT MIDDLE_TOP         = {0, RESOLUTION_X-1, MIDDLE_TOP_LINE_SY,       MIDDLE_TOP_LINE_EY,       RED};
RECT MIDDLE_BOTTOM      = {0, RESOLUTION_X-1, MIDDLE_BOTTOM_LINE_SY,    MIDDLE_BOTTOM_LINE_EY,    RED};
RECT LOWER_TOP          = {0, RESOLUTION_X-1, LOWER_TOP_LINE_SY,        LOWER_TOP_LINE_EY,        RED};
RECT LOWER_BOTTOM       = {0, RESOLUTION_X-1, LOWER_BOTTOM_LINE_SY,     LOWER_BOTTOM_LINE_EY,     RED};
RECT LOWERMOST_TOP      = {0, RESOLUTION_X-1, LOWERMOST_TOP_LINE_SY,    LOWERMOST_TOP_LINE_EY,    RED};
RECT LOWERMOST_BOTTOM   = {0, RESOLUTION_X-1, LOWERMOST_BOTTOM_LINE_SY, LOWERMOST_BOTTOM_LINE_EY, RED};
...
RECT HEAD            = {0,                        RESOLUTION_X-1,           UPPERMOST_LINE_SY,        UPPERMOST_LINE_EY,        BACKGROUND_COLOR};
RECT HEAD_MAINBUTTON = {LEFT_COLUMN_SX,           LEFT_COLUMN_EX,           UPPERMOST_LINE_SY,        UPPERMOST_LINE_EY,        EVEN_YELLOW};
RECT HEAD_LBUTTON    = {LEFT_PARAMS_LEFTHALF_SX,  LEFT_PARAMS_LEFTHALF_EX,  UPPERMOST_LINE_SY,        UPPERMOST_LINE_EY,        SHIFTED_EVEN_YELLOW};
RECT HEAD_RBUTTON    = {LEFT_PARAMS_RIGHTHALF_SX, LEFT_PARAMS_RIGHTHALF_EX, UPPERMOST_LINE_SY,        UPPERMOST_LINE_EY,        SHIFTED_EVEN_YELLOW};
RECT HEADER          = {RIGHTHALF_SX,             RIGHTHALF_EX,             UPPERMOST_LINE_SY,        UPPERMOST_LINE_EY,        BACKGROUND_COLOR};
RECT TOPIC           = {RIGHTHALF_SX,             RIGHT_COLUMN_SX-1,        UPPERMOST_TOP_LINE_SY,    UPPERMOST_TOP_LINE_EY,    ODD_GRAY};
RECT TITLE           = {RIGHTHALF_SX,             RIGHTHALF_EX,             UPPERMOST_BOTTOM_LINE_SY, UPPERMOST_BOTTOM_LINE_EY, EVEN_GRAY};
RECT TIME            = {RIGHT_COLUMN_SX,          RIGHT_COLUMN_EX,          UPPERMOST_TOP_LINE_SY,    UPPERMOST_TOP_LINE_EY,    ODD_GRAY};

RECT HEADER_WIDE     = {LEFT_PARAMS_LEFTHALF_SX,  RIGHTHALF_EX,             UPPERMOST_LINE_SY,        UPPERMOST_LINE_EY,        BACKGROUND_COLOR};
RECT TOPIC_WIDE      = {LEFT_PARAMS_LEFTHALF_SX,  RIGHT_COLUMN_SX-1,        UPPERMOST_TOP_LINE_SY,    UPPERMOST_TOP_LINE_EY,    ODD_GRAY};
RECT TITLE_WIDE      = {LEFT_PARAMS_LEFTHALF_SX,  RIGHTHALF_EX,             UPPERMOST_BOTTOM_LINE_SY, UPPERMOST_BOTTOM_LINE_EY, EVEN_GRAY};

RECT BODY = {0, RESOLUTION_X-1, UPPER_LINE_SY, LOWERMOST_LINE_EY, BACKGROUND_COLOR};

RECT UMLBUTTON = {LEFT_COLUMN_SX,  LEFT_COLUMN_EX,  UPPERMOST_LINE_SY, UPPERMOST_LINE_EY, BACKGROUND_COLOR};
RECT ULBUTTON  = {LEFT_COLUMN_SX,  LEFT_COLUMN_EX,  UPPER_LINE_SY,     UPPER_LINE_EY,     /*SHIFTED_*/ODD_GREEN};
RECT MLBUTTON  = {LEFT_COLUMN_SX,  LEFT_COLUMN_EX,  MIDDLE_LINE_SY,    MIDDLE_LINE_EY,    /*SHIFTED_*/EVEN_GREEN};
RECT LLBUTTON  = {LEFT_COLUMN_SX,  LEFT_COLUMN_EX,  LOWER_LINE_SY,     LOWER_LINE_EY,     /*SHIFTED_*/ODD_GREEN};
RECT LMLBUTTON = {LEFT_COLUMN_SX,  LEFT_COLUMN_EX,  LOWERMOST_LINE_SY, LOWERMOST_LINE_EY, /*SHIFTED_*/EVEN_GREEN};
RECT UMRBUTTON = {RIGHT_COLUMN_SX, RIGHT_COLUMN_EX, UPPERMOST_LINE_SY, UPPERMOST_LINE_EY, BACKGROUND_COLOR};
RECT URBUTTON  = {RIGHT_COLUMN_SX, RIGHT_COLUMN_EX, UPPER_LINE_SY,     UPPER_LINE_EY,     /*SHIFTED_*/EVEN_GREEN};
RECT MRBUTTON  = {RIGHT_COLUMN_SX, RIGHT_COLUMN_EX, MIDDLE_LINE_SY,    MIDDLE_LINE_EY,    /*SHIFTED_*/ODD_GREEN};
RECT LRBUTTON  = {RIGHT_COLUMN_SX, RIGHT_COLUMN_EX, LOWER_LINE_SY,     LOWER_LINE_EY,     /*SHIFTED_*/EVEN_GREEN};
RECT LMRBUTTON = {RIGHT_COLUMN_SX, RIGHT_COLUMN_EX, LOWERMOST_LINE_SY, LOWERMOST_LINE_EY, /*SHIFTED_*/ODD_GREEN};
...
RECT ULBUTTON_BIG = {LEFT_COLUMN_SX,  LEFT_COLUMN_EX,  UPPER_LINE_SY, MIDDLE_LINE_EY,    ODD_GREEN};
RECT URBUTTON_BIG = {RIGHT_COLUMN_SX, RIGHT_COLUMN_EX, UPPER_LINE_SY, MIDDLE_LINE_EY,    EVEN_GREEN};
RECT LLBUTTON_BIG = {LEFT_COLUMN_SX,  LEFT_COLUMN_EX,  LOWER_LINE_SY, LOWERMOST_LINE_EY, EVEN_GREEN};
RECT LRBUTTON_BIG = {RIGHT_COLUMN_SX, RIGHT_COLUMN_EX, LOWER_LINE_SY, LOWERMOST_LINE_EY, ODD_GREEN};

const RECT* BORDER_BUTTONS_UD_BIG[4] = {&ULBUTTON_BIG, &LLBUTTON_BIG, &URBUTTON_BIG, &LRBUTTON_BIG};

RECT UPARAM  = {LEFT_PARAMS_SX,  RIGHT_PARAMS_EX,  UPPER_LINE_SY,     UPPER_LINE_EY,     ODD_GREEN};
RECT MPARAM  = {LEFT_PARAMS_SX,  RIGHT_PARAMS_EX,  MIDDLE_LINE_SY,    MIDDLE_LINE_EY,    EVEN_GREEN};
RECT LPARAM  = {LEFT_PARAMS_SX,  RIGHT_PARAMS_EX,  LOWER_LINE_SY,     LOWER_LINE_EY,     ODD_GREEN};
RECT LMPARAM = {LEFT_PARAMS_SX,  RIGHT_PARAMS_EX,  LOWERMOST_LINE_SY, LOWERMOST_LINE_EY, EVEN_GREEN};

RECT UMLPARAM = {LEFT_PARAMS_SX,  LEFT_PARAMS_EX,  UPPERMOST_LINE_SY, UPPERMOST_LINE_EY, BACKGROUND_COLOR};
RECT ULPARAM  = {LEFT_PARAMS_SX,  LEFT_PARAMS_EX,  UPPER_LINE_SY,     UPPER_LINE_EY,     ODD_GREEN};
RECT MLPARAM  = {LEFT_PARAMS_SX,  LEFT_PARAMS_EX,  MIDDLE_LINE_SY,    MIDDLE_LINE_EY,    EVEN_GREEN};
RECT LLPARAM  = {LEFT_PARAMS_SX,  LEFT_PARAMS_EX,  LOWER_LINE_SY,     LOWER_LINE_EY,     ODD_GREEN};
RECT LMLPARAM = {LEFT_PARAMS_SX,  LEFT_PARAMS_EX,  LOWERMOST_LINE_SY, LOWERMOST_LINE_EY, EVEN_GREEN};
RECT UMRPARAM = {RIGHT_PARAMS_SX, RIGHT_PARAMS_EX, UPPERMOST_LINE_SY, UPPERMOST_LINE_EY, BACKGROUND_COLOR};
RECT URPARAM  = {RIGHT_PARAMS_SX, RIGHT_PARAMS_EX, UPPER_LINE_SY,     UPPER_LINE_EY,     EVEN_GREEN};
RECT MRPARAM  = {RIGHT_PARAMS_SX, RIGHT_PARAMS_EX, MIDDLE_LINE_SY,    MIDDLE_LINE_EY,    ODD_GREEN};
RECT LRPARAM  = {RIGHT_PARAMS_SX, RIGHT_PARAMS_EX, LOWER_LINE_SY,     LOWER_LINE_EY,     EVEN_GREEN};
RECT LMRPARAM = {RIGHT_PARAMS_SX, RIGHT_PARAMS_EX, LOWERMOST_LINE_SY, LOWERMOST_LINE_EY, ODD_GREEN};

RECT UCAPTION  = {LEFT_PARAMS_SX,  RIGHT_PARAMS_EX,  UPPER_TOP_LINE_SY,     UPPER_TOP_LINE_EY,     ODD_GREEN};
RECT MCAPTION  = {LEFT_PARAMS_SX,  RIGHT_PARAMS_EX,  MIDDLE_TOP_LINE_SY,    MIDDLE_TOP_LINE_EY,    EVEN_GREEN};
RECT LCAPTION  = {LEFT_PARAMS_SX,  RIGHT_PARAMS_EX,  LOWER_TOP_LINE_SY,     LOWER_TOP_LINE_EY,     ODD_GREEN};
RECT LMCAPTION = {LEFT_PARAMS_SX,  RIGHT_PARAMS_EX,  LOWERMOST_TOP_LINE_SY, LOWERMOST_TOP_LINE_EY, EVEN_GREEN};

RECT UMLCAPTION = {LEFT_PARAMS_SX,  LEFT_PARAMS_EX,  UPPERMOST_TOP_LINE_SY, UPPERMOST_TOP_LINE_EY, BACKGROUND_COLOR};
RECT ULCAPTION  = {LEFT_PARAMS_SX,  LEFT_PARAMS_EX,  UPPER_TOP_LINE_SY,     UPPER_TOP_LINE_EY,     ODD_GREEN};
RECT MLCAPTION  = {LEFT_PARAMS_SX,  LEFT_PARAMS_EX,  MIDDLE_TOP_LINE_SY,    MIDDLE_TOP_LINE_EY,    EVEN_GREEN};
RECT LLCAPTION  = {LEFT_PARAMS_SX,  LEFT_PARAMS_EX,  LOWER_TOP_LINE_SY,     LOWER_TOP_LINE_EY,     ODD_GREEN};
RECT LMLCAPTION = {LEFT_PARAMS_SX,  LEFT_PARAMS_EX,  LOWERMOST_TOP_LINE_SY, LOWERMOST_TOP_LINE_EY, EVEN_GREEN};
RECT UMRCAPTION = {RIGHT_PARAMS_SX, RIGHT_PARAMS_EX, UPPERMOST_TOP_LINE_SY, UPPERMOST_TOP_LINE_EY, BACKGROUND_COLOR};
RECT URCAPTION  = {RIGHT_PARAMS_SX, RIGHT_PARAMS_EX, UPPER_TOP_LINE_SY,     UPPER_TOP_LINE_EY,     EVEN_GREEN};
RECT MRCAPTION  = {RIGHT_PARAMS_SX, RIGHT_PARAMS_EX, MIDDLE_TOP_LINE_SY,    MIDDLE_TOP_LINE_EY,    ODD_GREEN};
RECT LRCAPTION  = {RIGHT_PARAMS_SX, RIGHT_PARAMS_EX, LOWER_TOP_LINE_SY,     LOWER_TOP_LINE_EY,     EVEN_GREEN};
RECT LMRCAPTION = {RIGHT_PARAMS_SX, RIGHT_PARAMS_EX, LOWERMOST_TOP_LINE_SY, LOWERMOST_TOP_LINE_EY, ODD_GREEN};

RECT UVALUE  = {LEFT_PARAMS_SX,  RIGHT_PARAMS_EX,  UPPER_BOTTOM_LINE_SY,     UPPER_BOTTOM_LINE_EY,     ODD_GREEN};
RECT MVALUE  = {LEFT_PARAMS_SX,  RIGHT_PARAMS_EX,  MIDDLE_BOTTOM_LINE_SY,    MIDDLE_BOTTOM_LINE_EY,    EVEN_GREEN};
RECT LVALUE  = {LEFT_PARAMS_SX,  RIGHT_PARAMS_EX,  LOWER_BOTTOM_LINE_SY,     LOWER_BOTTOM_LINE_EY,     ODD_GREEN};
RECT LMVALUE = {LEFT_PARAMS_SX,  RIGHT_PARAMS_EX,  LOWERMOST_BOTTOM_LINE_SY, LOWERMOST_BOTTOM_LINE_EY, EVEN_GREEN};

RECT UMLVALUE = {LEFT_PARAMS_SX,  LEFT_PARAMS_EX,  UPPERMOST_BOTTOM_LINE_SY, UPPERMOST_BOTTOM_LINE_EY, BACKGROUND_COLOR};
RECT ULVALUE  = {LEFT_PARAMS_SX,  LEFT_PARAMS_EX,  UPPER_BOTTOM_LINE_SY,     UPPER_BOTTOM_LINE_EY,     ODD_GREEN};
RECT MLVALUE  = {LEFT_PARAMS_SX,  LEFT_PARAMS_EX,  MIDDLE_BOTTOM_LINE_SY,    MIDDLE_BOTTOM_LINE_EY,    EVEN_GREEN};
RECT LLVALUE  = {LEFT_PARAMS_SX,  LEFT_PARAMS_EX,  LOWER_BOTTOM_LINE_SY,     LOWER_BOTTOM_LINE_EY,     ODD_GREEN};
RECT LMLVALUE = {LEFT_PARAMS_SX,  LEFT_PARAMS_EX,  LOWERMOST_BOTTOM_LINE_SY, LOWERMOST_BOTTOM_LINE_EY, EVEN_GREEN};
RECT UMRVALUE = {RIGHT_PARAMS_SX, RIGHT_PARAMS_EX, UPPERMOST_BOTTOM_LINE_SY, UPPERMOST_BOTTOM_LINE_EY, BACKGROUND_COLOR};
RECT URVALUE  = {RIGHT_PARAMS_SX, RIGHT_PARAMS_EX, UPPER_BOTTOM_LINE_SY,     UPPER_BOTTOM_LINE_EY,     EVEN_GREEN};
RECT MRVALUE  = {RIGHT_PARAMS_SX, RIGHT_PARAMS_EX, MIDDLE_BOTTOM_LINE_SY,    MIDDLE_BOTTOM_LINE_EY,    ODD_GREEN};
RECT LRVALUE  = {RIGHT_PARAMS_SX, RIGHT_PARAMS_EX, LOWER_BOTTOM_LINE_SY,     LOWER_BOTTOM_LINE_EY,     EVEN_GREEN};
RECT LMRVALUE = {RIGHT_PARAMS_SX, RIGHT_PARAMS_EX, LOWERMOST_BOTTOM_LINE_SY, LOWERMOST_BOTTOM_LINE_EY, ODD_GREEN};
...
RECT ULVALUE_BIG  = {LEFT_PARAMS_SX,  LEFT_PARAMS_EX,  UPPER_BOTTOM_LINE_SY, UPPER_BOTTOM_LINE_EY,  ODD_GREEN};
RECT LLVALUE_BIG  = {LEFT_PARAMS_SX,  LEFT_PARAMS_EX,  LOWER_BOTTOM_LINE_SY, LOWER_BOTTOM_LINE_EY,  EVEN_GREEN};
RECT URVALUE_BIG  = {RIGHT_PARAMS_SX, RIGHT_PARAMS_EX, UPPER_BOTTOM_LINE_SY, UPPER_BOTTOM_LINE_EY,  EVEN_GREEN};
RECT LRVALUE_BIG  = {RIGHT_PARAMS_SX, RIGHT_PARAMS_EX, LOWER_BOTTOM_LINE_SY, LOWER_BOTTOM_LINE_EY,  ODD_GREEN};

const RECT* CAPTIONS_UD_BIG[4] = {&ULVALUE_BIG, &LLVALUE_BIG, &URVALUE_BIG, &LRVALUE_BIG};

RECT ULPARAM_BIG = {LEFT_PARAMS_SX,  LEFT_PARAMS_EX,  UPPER_LINE_SY, MIDDLE_LINE_EY,    ODD_GREEN};
RECT URPARAM_BIG = {RIGHT_PARAMS_SX, RIGHT_PARAMS_EX, UPPER_LINE_SY, MIDDLE_LINE_EY,    EVEN_GREEN};
RECT LLPARAM_BIG = {LEFT_PARAMS_SX,  LEFT_PARAMS_EX,  LOWER_LINE_SY, LOWERMOST_LINE_EY, EVEN_GREEN};
RECT LRPARAM_BIG = {RIGHT_PARAMS_SX, RIGHT_PARAMS_EX, LOWER_LINE_SY, LOWERMOST_LINE_EY, ODD_GREEN};

const RECT* PARAMS_UD_BIG[4] = {&ULPARAM_BIG, &LLPARAM_BIG, &URPARAM_BIG, &LRPARAM_BIG};

RECT UMLLPARAM = {LEFT_PARAMS_LEFTHALF_SX,  LEFT_PARAMS_LEFTHALF_EX,  UPPERMOST_LINE_SY, UPPERMOST_LINE_EY, BACKGROUND_COLOR};
RECT ULLPARAM  = {LEFT_PARAMS_LEFTHALF_SX,  LEFT_PARAMS_LEFTHALF_EX,  UPPER_LINE_SY,     UPPER_LINE_EY,     ODD_GREEN};
RECT MLLPARAM  = {LEFT_PARAMS_LEFTHALF_SX,  LEFT_PARAMS_LEFTHALF_EX,  MIDDLE_LINE_SY,    MIDDLE_LINE_EY,    EVEN_GREEN};
RECT LLLPARAM  = {LEFT_PARAMS_LEFTHALF_SX,  LEFT_PARAMS_LEFTHALF_EX,  LOWER_LINE_SY,     LOWER_LINE_EY,     ODD_GREEN};
RECT LMLLPARAM = {LEFT_PARAMS_LEFTHALF_SX,  LEFT_PARAMS_LEFTHALF_EX,  LOWERMOST_LINE_SY, LOWERMOST_LINE_EY, EVEN_GREEN};
RECT UMRLPARAM = {RIGHT_PARAMS_LEFTHALF_SX, RIGHT_PARAMS_LEFTHALF_EX, UPPERMOST_LINE_SY, UPPERMOST_LINE_EY, BACKGROUND_COLOR};
RECT URLPARAM  = {RIGHT_PARAMS_LEFTHALF_SX, RIGHT_PARAMS_LEFTHALF_EX, UPPER_LINE_SY,     UPPER_LINE_EY,     EVEN_GREEN};
RECT MRLPARAM  = {RIGHT_PARAMS_LEFTHALF_SX, RIGHT_PARAMS_LEFTHALF_EX, MIDDLE_LINE_SY,    MIDDLE_LINE_EY,    ODD_GREEN};
RECT LRLPARAM  = {RIGHT_PARAMS_LEFTHALF_SX, RIGHT_PARAMS_LEFTHALF_EX, LOWER_LINE_SY,     LOWER_LINE_EY,     EVEN_GREEN};
RECT LMRLPARAM = {RIGHT_PARAMS_LEFTHALF_SX, RIGHT_PARAMS_LEFTHALF_EX, LOWERMOST_LINE_SY, LOWERMOST_LINE_EY, ODD_GREEN};

RECT UMLLCAPTION = {LEFT_PARAMS_LEFTHALF_SX,  LEFT_PARAMS_LEFTHALF_EX,  UPPERMOST_TOP_LINE_SY, UPPERMOST_TOP_LINE_EY, BACKGROUND_COLOR};
RECT ULLCAPTION  = {LEFT_PARAMS_LEFTHALF_SX,  LEFT_PARAMS_LEFTHALF_EX,  UPPER_TOP_LINE_SY,     UPPER_TOP_LINE_EY,     ODD_GREEN};
RECT MLLCAPTION  = {LEFT_PARAMS_LEFTHALF_SX,  LEFT_PARAMS_LEFTHALF_EX,  MIDDLE_TOP_LINE_SY,    MIDDLE_TOP_LINE_EY,    EVEN_GREEN};
RECT LLLCAPTION  = {LEFT_PARAMS_LEFTHALF_SX,  LEFT_PARAMS_LEFTHALF_EX,  LOWER_TOP_LINE_SY,     LOWER_TOP_LINE_EY,     ODD_GREEN};
RECT LMLLCAPTION = {LEFT_PARAMS_LEFTHALF_SX,  LEFT_PARAMS_LEFTHALF_EX,  LOWERMOST_TOP_LINE_SY, LOWERMOST_TOP_LINE_EY, EVEN_GREEN};
RECT UMRLCAPTION = {RIGHT_PARAMS_LEFTHALF_SX, RIGHT_PARAMS_LEFTHALF_EX, UPPERMOST_TOP_LINE_SY, UPPERMOST_TOP_LINE_EY, BACKGROUND_COLOR};
RECT URLCAPTION  = {RIGHT_PARAMS_LEFTHALF_SX, RIGHT_PARAMS_LEFTHALF_EX, UPPER_TOP_LINE_SY,     UPPER_TOP_LINE_EY,     EVEN_GREEN};
RECT MRLCAPTION  = {RIGHT_PARAMS_LEFTHALF_SX, RIGHT_PARAMS_LEFTHALF_EX, MIDDLE_TOP_LINE_SY,    MIDDLE_TOP_LINE_EY,    ODD_GREEN};
RECT LRLCAPTION  = {RIGHT_PARAMS_LEFTHALF_SX, RIGHT_PARAMS_LEFTHALF_EX, LOWER_TOP_LINE_SY,     LOWER_TOP_LINE_EY,     EVEN_GREEN};
RECT LMRLCAPTION = {RIGHT_PARAMS_LEFTHALF_SX, RIGHT_PARAMS_LEFTHALF_EX, LOWERMOST_TOP_LINE_SY, LOWERMOST_TOP_LINE_EY, ODD_GREEN};

RECT UMLLVALUE = {LEFT_PARAMS_LEFTHALF_SX,  LEFT_PARAMS_LEFTHALF_EX,  UPPERMOST_BOTTOM_LINE_SY, UPPERMOST_BOTTOM_LINE_EY, BACKGROUND_COLOR};
RECT ULLVALUE  = {LEFT_PARAMS_LEFTHALF_SX,  LEFT_PARAMS_LEFTHALF_EX,  UPPER_BOTTOM_LINE_SY,     UPPER_BOTTOM_LINE_EY,     ODD_GREEN};
RECT MLLVALUE  = {LEFT_PARAMS_LEFTHALF_SX,  LEFT_PARAMS_LEFTHALF_EX,  MIDDLE_BOTTOM_LINE_SY,    MIDDLE_BOTTOM_LINE_EY,    EVEN_GREEN};
RECT LLLVALUE  = {LEFT_PARAMS_LEFTHALF_SX,  LEFT_PARAMS_LEFTHALF_EX,  LOWER_BOTTOM_LINE_SY,     LOWER_BOTTOM_LINE_EY,     ODD_GREEN};
RECT LMLLVALUE = {LEFT_PARAMS_LEFTHALF_SX,  LEFT_PARAMS_LEFTHALF_EX,  LOWERMOST_BOTTOM_LINE_SY, LOWERMOST_BOTTOM_LINE_EY, EVEN_GREEN};
RECT UMRLVALUE = {RIGHT_PARAMS_LEFTHALF_SX, RIGHT_PARAMS_LEFTHALF_EX, UPPERMOST_BOTTOM_LINE_SY, UPPERMOST_BOTTOM_LINE_EY, BACKGROUND_COLOR};
RECT URLVALUE  = {RIGHT_PARAMS_LEFTHALF_SX, RIGHT_PARAMS_LEFTHALF_EX, UPPER_BOTTOM_LINE_SY,     UPPER_BOTTOM_LINE_EY,     EVEN_GREEN};
RECT MRLVALUE  = {RIGHT_PARAMS_LEFTHALF_SX, RIGHT_PARAMS_LEFTHALF_EX, MIDDLE_BOTTOM_LINE_SY,    MIDDLE_BOTTOM_LINE_EY,    ODD_GREEN};
RECT LRLVALUE  = {RIGHT_PARAMS_LEFTHALF_SX, RIGHT_PARAMS_LEFTHALF_EX, LOWER_BOTTOM_LINE_SY,     LOWER_BOTTOM_LINE_EY,     EVEN_GREEN};
RECT LMRLVALUE = {RIGHT_PARAMS_LEFTHALF_SX, RIGHT_PARAMS_LEFTHALF_EX, LOWERMOST_BOTTOM_LINE_SY, LOWERMOST_BOTTOM_LINE_EY, ODD_GREEN};
...
RECT ULCAPTION_BIG  = {LEFT_PARAMS_SX,  LEFT_PARAMS_EX,  UPPER_TOP_LINE_SY, UPPER_TOP_LINE_EY, ODD_GREEN};
RECT LLCAPTION_BIG  = {LEFT_PARAMS_SX,  LEFT_PARAMS_EX,  LOWER_TOP_LINE_SY, LOWER_TOP_LINE_EY, EVEN_GREEN};
RECT URCAPTION_BIG  = {RIGHT_PARAMS_SX, RIGHT_PARAMS_EX, UPPER_TOP_LINE_SY, UPPER_TOP_LINE_EY, EVEN_GREEN};
RECT LRCAPTION_BIG  = {RIGHT_PARAMS_SX, RIGHT_PARAMS_EX, LOWER_TOP_LINE_SY, LOWER_TOP_LINE_EY, ODD_GREEN};

const RECT* UCAPTIONS_UD_BIG[4] = {&ULCAPTION_BIG, &LLCAPTION_BIG, &URCAPTION_BIG, &LRCAPTION_BIG};

RECT UMLRPARAM = {LEFT_PARAMS_RIGHTHALF_SX,  LEFT_PARAMS_RIGHTHALF_EX,  UPPERMOST_LINE_SY, UPPERMOST_LINE_EY, BACKGROUND_COLOR};
RECT ULRPARAM  = {LEFT_PARAMS_RIGHTHALF_SX,  LEFT_PARAMS_RIGHTHALF_EX,  UPPER_LINE_SY,     UPPER_LINE_EY,     ODD_GREEN};
RECT MLRPARAM  = {LEFT_PARAMS_RIGHTHALF_SX,  LEFT_PARAMS_RIGHTHALF_EX,  MIDDLE_LINE_SY,    MIDDLE_LINE_EY,    EVEN_GREEN};
RECT LLRPARAM  = {LEFT_PARAMS_RIGHTHALF_SX,  LEFT_PARAMS_RIGHTHALF_EX,  LOWER_LINE_SY,     LOWER_LINE_EY,     ODD_GREEN};
RECT LMLRPARAM = {LEFT_PARAMS_RIGHTHALF_SX,  LEFT_PARAMS_RIGHTHALF_EX,  LOWERMOST_LINE_SY, LOWERMOST_LINE_EY, EVEN_GREEN};
RECT UMRRPARAM = {RIGHT_PARAMS_RIGHTHALF_SX, RIGHT_PARAMS_RIGHTHALF_EX, UPPERMOST_LINE_SY, UPPERMOST_LINE_EY, BACKGROUND_COLOR};
RECT URRPARAM  = {RIGHT_PARAMS_RIGHTHALF_SX, RIGHT_PARAMS_RIGHTHALF_EX, UPPER_LINE_SY,     UPPER_LINE_EY,     EVEN_GREEN};
RECT MRRPARAM  = {RIGHT_PARAMS_RIGHTHALF_SX, RIGHT_PARAMS_RIGHTHALF_EX, MIDDLE_LINE_SY,    MIDDLE_LINE_EY,    ODD_GREEN};
RECT LRRPARAM  = {RIGHT_PARAMS_RIGHTHALF_SX, RIGHT_PARAMS_RIGHTHALF_EX, LOWER_LINE_SY,     LOWER_LINE_EY,     EVEN_GREEN};
RECT LMRRPARAM = {RIGHT_PARAMS_RIGHTHALF_SX, RIGHT_PARAMS_RIGHTHALF_EX, LOWERMOST_LINE_SY, LOWERMOST_LINE_EY, ODD_GREEN};

RECT UMLRCAPTION = {LEFT_PARAMS_RIGHTHALF_SX,  LEFT_PARAMS_RIGHTHALF_EX,  UPPERMOST_TOP_LINE_SY, UPPERMOST_TOP_LINE_EY, BACKGROUND_COLOR};
RECT ULRCAPTION  = {LEFT_PARAMS_RIGHTHALF_SX,  LEFT_PARAMS_RIGHTHALF_EX,  UPPER_TOP_LINE_SY,     UPPER_TOP_LINE_EY,     ODD_GREEN};
RECT MLRCAPTION  = {LEFT_PARAMS_RIGHTHALF_SX,  LEFT_PARAMS_RIGHTHALF_EX,  MIDDLE_TOP_LINE_SY,    MIDDLE_TOP_LINE_EY,    EVEN_GREEN};
RECT LLRCAPTION  = {LEFT_PARAMS_RIGHTHALF_SX,  LEFT_PARAMS_RIGHTHALF_EX,  LOWER_TOP_LINE_SY,     LOWER_TOP_LINE_EY,     ODD_GREEN};
RECT LMLRCAPTION = {LEFT_PARAMS_RIGHTHALF_SX,  LEFT_PARAMS_RIGHTHALF_EX,  LOWERMOST_TOP_LINE_SY, LOWERMOST_TOP_LINE_EY, EVEN_GREEN};
RECT UMRRCAPTION = {RIGHT_PARAMS_RIGHTHALF_SX, RIGHT_PARAMS_RIGHTHALF_EX, UPPERMOST_TOP_LINE_SY, UPPERMOST_TOP_LINE_EY, BACKGROUND_COLOR};
RECT URRCAPTION  = {RIGHT_PARAMS_RIGHTHALF_SX, RIGHT_PARAMS_RIGHTHALF_EX, UPPER_TOP_LINE_SY,     UPPER_TOP_LINE_EY,     EVEN_GREEN};
RECT MRRCAPTION  = {RIGHT_PARAMS_RIGHTHALF_SX, RIGHT_PARAMS_RIGHTHALF_EX, MIDDLE_TOP_LINE_SY,    MIDDLE_TOP_LINE_EY,    ODD_GREEN};
RECT LRRCAPTION  = {RIGHT_PARAMS_RIGHTHALF_SX, RIGHT_PARAMS_RIGHTHALF_EX, LOWER_TOP_LINE_SY,     LOWER_TOP_LINE_EY,     EVEN_GREEN};
RECT LMRRCAPTION = {RIGHT_PARAMS_RIGHTHALF_SX, RIGHT_PARAMS_RIGHTHALF_EX, LOWERMOST_TOP_LINE_SY, LOWERMOST_TOP_LINE_EY, ODD_GREEN};

RECT UMLRVALUE = {LEFT_PARAMS_RIGHTHALF_SX,  LEFT_PARAMS_RIGHTHALF_EX,  UPPERMOST_BOTTOM_LINE_SY, UPPERMOST_BOTTOM_LINE_EY, BACKGROUND_COLOR};
RECT ULRVALUE  = {LEFT_PARAMS_RIGHTHALF_SX,  LEFT_PARAMS_RIGHTHALF_EX,  UPPER_BOTTOM_LINE_SY,     UPPER_BOTTOM_LINE_EY,     ODD_GREEN};
RECT MLRVALUE  = {LEFT_PARAMS_RIGHTHALF_SX,  LEFT_PARAMS_RIGHTHALF_EX,  MIDDLE_BOTTOM_LINE_SY,    MIDDLE_BOTTOM_LINE_EY,    EVEN_GREEN};
RECT LLRVALUE  = {LEFT_PARAMS_RIGHTHALF_SX,  LEFT_PARAMS_RIGHTHALF_EX,  LOWER_BOTTOM_LINE_SY,     LOWER_BOTTOM_LINE_EY,     ODD_GREEN};
RECT LMLRVALUE = {LEFT_PARAMS_RIGHTHALF_SX,  LEFT_PARAMS_RIGHTHALF_EX,  LOWERMOST_BOTTOM_LINE_SY, LOWERMOST_BOTTOM_LINE_EY, EVEN_GREEN};
RECT UMRRVALUE = {RIGHT_PARAMS_RIGHTHALF_SX, RIGHT_PARAMS_RIGHTHALF_EX, UPPERMOST_BOTTOM_LINE_SY, UPPERMOST_BOTTOM_LINE_EY, BACKGROUND_COLOR};
RECT URRVALUE  = {RIGHT_PARAMS_RIGHTHALF_SX, RIGHT_PARAMS_RIGHTHALF_EX, UPPER_BOTTOM_LINE_SY,     UPPER_BOTTOM_LINE_EY,     EVEN_GREEN};
RECT MRRVALUE  = {RIGHT_PARAMS_RIGHTHALF_SX, RIGHT_PARAMS_RIGHTHALF_EX, MIDDLE_BOTTOM_LINE_SY,    MIDDLE_BOTTOM_LINE_EY,    ODD_GREEN};
RECT LRRVALUE  = {RIGHT_PARAMS_RIGHTHALF_SX, RIGHT_PARAMS_RIGHTHALF_EX, LOWER_BOTTOM_LINE_SY,     LOWER_BOTTOM_LINE_EY,     EVEN_GREEN};
RECT LMRRVALUE = {RIGHT_PARAMS_RIGHTHALF_SX, RIGHT_PARAMS_RIGHTHALF_EX, LOWERMOST_BOTTOM_LINE_SY, LOWERMOST_BOTTOM_LINE_EY, ODD_GREEN};
...
RECT MLCAPTION_BIG  = {LEFT_PARAMS_SX,  LEFT_PARAMS_EX,  MIDDLE_TOP_LINE_SY,    MIDDLE_TOP_LINE_EY,    ODD_GREEN};
RECT LMLCAPTION_BIG = {LEFT_PARAMS_SX,  LEFT_PARAMS_EX,  LOWERMOST_TOP_LINE_SY, LOWERMOST_TOP_LINE_EY, EVEN_GREEN};
RECT MRCAPTION_BIG  = {RIGHT_PARAMS_SX, RIGHT_PARAMS_EX, MIDDLE_TOP_LINE_SY,    MIDDLE_TOP_LINE_EY,    EVEN_GREEN};
RECT LMRCAPTION_BIG = {RIGHT_PARAMS_SX, RIGHT_PARAMS_EX, LOWERMOST_TOP_LINE_SY, LOWERMOST_TOP_LINE_EY, ODD_GREEN};

const RECT* LCAPTIONS_UD_BIG[4] = {&MLCAPTION_BIG, &LMLCAPTION_BIG, &MRCAPTION_BIG, &LMRCAPTION_BIG};

RECT LEFT_TWOTHIRDS_UPPERMOST  = {LEFTTHIRD_SX,  CENTRALTHIRD_EX, UPPERMOST_LINE_SY,     UPPERMOST_LINE_EY,     BLUE};
RECT LEFT_TWOTHIRDS_UPPER      = {LEFTTHIRD_SX,  CENTRALTHIRD_EX, UPPER_LINE_SY,         UPPER_LINE_EY,         BLUE};
RECT LEFT_TWOTHIRDS_MIDDLE     = {LEFTTHIRD_SX,  CENTRALTHIRD_EX, MIDDLE_LINE_SY,        MIDDLE_LINE_EY,        BLUE};
RECT LEFT_TWOTHIRDS_LOWER      = {LEFTTHIRD_SX,  CENTRALTHIRD_EX, LOWER_LINE_SY,         LOWER_LINE_EY,         BLUE};
RECT LEFT_TWOTHIRDS_LOWERMOST  = {LEFTTHIRD_SX,  CENTRALTHIRD_EX, LOWERMOST_LINE_SY,     LOWERMOST_LINE_EY,     BLUE};
RECT RIGHT_THIRD_UPPERMOST     = {RIGHTTHIRD_SX, RIGHTTHIRD_EX,   UPPERMOST_LINE_SY,     UPPERMOST_LINE_EY,     BLUE};
RECT RIGHT_THIRD_UPPER         = {RIGHTTHIRD_SX, RIGHTTHIRD_EX,   UPPER_LINE_SY,         UPPER_LINE_EY,         BLUE};
RECT RIGHT_THIRD_MIDDLE        = {RIGHTTHIRD_SX, RIGHTTHIRD_EX,   MIDDLE_LINE_SY,        MIDDLE_LINE_EY,        BLUE};
RECT RIGHT_THIRD_LOWER         = {RIGHTTHIRD_SX, RIGHTTHIRD_EX,   LOWER_LINE_SY,         LOWER_LINE_EY,         BLUE};
RECT RIGHT_THIRD_LOWERMOST     = {RIGHTTHIRD_SX, RIGHTTHIRD_EX,   LOWERMOST_LINE_SY,     LOWERMOST_LINE_EY,     BLUE};

RECT RIGHT_THIRD_MIDDLE_TOP    = {RIGHTTHIRD_SX, RIGHTTHIRD_EX,   MIDDLE_TOP_LINE_SY,    MIDDLE_TOP_LINE_EY,    BLUE};
RECT RIGHT_THIRD_MIDDLE_BOTTOM = {RIGHTTHIRD_SX, RIGHTTHIRD_EX,   MIDDLE_BOTTOM_LINE_SY, MIDDLE_BOTTOM_LINE_EY, BLUE};

RECT LEFTHALF_UPPERMOST  = {LEFTHALF_SX,  LEFTHALF_EX,  UPPERMOST_LINE_SY,   UPPERMOST_LINE_EY, BLUE};
RECT LEFTHALF_UPPER      = {LEFTHALF_SX,  LEFTHALF_EX,  UPPER_LINE_SY,       UPPER_LINE_EY,     BLUE};
RECT LEFTHALF_MIDDLE     = {LEFTHALF_SX,  LEFTHALF_EX,  MIDDLE_LINE_SY,      MIDDLE_LINE_EY,    BLUE};
RECT LEFTHALF_LOWER      = {LEFTHALF_SX,  LEFTHALF_EX,  LOWER_LINE_SY,       LOWER_LINE_EY,     BLUE};
RECT LEFTHALF_LOWERMOST  = {LEFTHALF_SX,  LEFTHALF_EX,  LOWERMOST_LINE_SY,   LOWERMOST_LINE_EY, BLUE};
RECT RIGHTHALF_UPPERMOST = {RIGHTHALF_SX, RIGHTHALF_EX, UPPERMOST_LINE_SY,   UPPERMOST_LINE_EY, BLUE};
RECT RIGHTHALF_UPPER     = {RIGHTHALF_SX, RIGHTHALF_EX, UPPER_LINE_SY,       UPPER_LINE_EY,     BLUE};
RECT RIGHTHALF_MIDDLE    = {RIGHTHALF_SX, RIGHTHALF_EX, MIDDLE_LINE_SY,      MIDDLE_LINE_EY,    BLUE};
RECT RIGHTHALF_LOWER     = {RIGHTHALF_SX, RIGHTHALF_EX, LOWER_LINE_SY,       LOWER_LINE_EY,     BLUE};
RECT RIGHTHALF_LOWERMOST = {RIGHTHALF_SX, RIGHTHALF_EX, LOWERMOST_LINE_SY,   LOWERMOST_LINE_EY, BLUE};

RECT LEFTHALF_UPPERMOST_TOP     = {LEFTHALF_SX,  LEFTHALF_EX,  UPPERMOST_TOP_LINE_SY,    UPPERMOST_TOP_LINE_EY,    BLUE};
RECT LEFTHALF_UPPERMOST_BOTTOM  = {LEFTHALF_SX,  LEFTHALF_EX,  UPPERMOST_BOTTOM_LINE_SY, UPPERMOST_BOTTOM_LINE_EY, BLUE};
RECT LEFTHALF_UPPER_TOP         = {LEFTHALF_SX,  LEFTHALF_EX,  UPPER_TOP_LINE_SY,        UPPER_TOP_LINE_EY,        BLUE};
RECT LEFTHALF_UPPER_BOTTOM      = {LEFTHALF_SX,  LEFTHALF_EX,  UPPER_BOTTOM_LINE_SY,     UPPER_BOTTOM_LINE_EY,     BLUE};
RECT LEFTHALF_MIDDLE_TOP        = {LEFTHALF_SX,  LEFTHALF_EX,  MIDDLE_TOP_LINE_SY,       MIDDLE_TOP_LINE_EY,       BLUE};
RECT LEFTHALF_MIDDLE_BOTTOM     = {LEFTHALF_SX,  LEFTHALF_EX,  MIDDLE_BOTTOM_LINE_SY,    MIDDLE_BOTTOM_LINE_EY,    BLUE};
RECT LEFTHALF_LOWER_TOP         = {LEFTHALF_SX,  LEFTHALF_EX,  LOWER_TOP_LINE_SY,        LOWER_TOP_LINE_EY,        BLUE};
RECT LEFTHALF_LOWER_BOTTOM      = {LEFTHALF_SX,  LEFTHALF_EX,  LOWER_BOTTOM_LINE_SY,     LOWER_BOTTOM_LINE_EY,     BLUE};
RECT LEFTHALF_LOWERMOST_TOP     = {LEFTHALF_SX,  LEFTHALF_EX,  LOWERMOST_TOP_LINE_SY,    LOWERMOST_TOP_LINE_EY,    BLUE};
RECT LEFTHALF_LOWERMOST_BOTTOM  = {LEFTHALF_SX,  LEFTHALF_EX,  LOWERMOST_BOTTOM_LINE_SY, LOWERMOST_BOTTOM_LINE_EY, BLUE};
RECT RIGHTHALF_UPPERMOST_TOP    = {RIGHTHALF_SX, RIGHTHALF_EX, UPPERMOST_TOP_LINE_SY,    UPPERMOST_TOP_LINE_EY,    BLUE};
RECT RIGHTHALF_UPPERMOST_BOTTOM = {RIGHTHALF_SX, RIGHTHALF_EX, UPPERMOST_BOTTOM_LINE_SY, UPPERMOST_BOTTOM_LINE_EY, BLUE};
RECT RIGHTHALF_UPPER_TOP        = {RIGHTHALF_SX, RIGHTHALF_EX, UPPER_TOP_LINE_SY,        UPPER_TOP_LINE_EY,        BLUE};
RECT RIGHTHALF_UPPER_BOTTOM     = {RIGHTHALF_SX, RIGHTHALF_EX, UPPER_BOTTOM_LINE_SY,     UPPER_BOTTOM_LINE_EY,     BLUE};
RECT RIGHTHALF_MIDDLE_TOP       = {RIGHTHALF_SX, RIGHTHALF_EX, MIDDLE_TOP_LINE_SY,       MIDDLE_TOP_LINE_EY,       BLUE};
RECT RIGHTHALF_MIDDLE_BOTTOM    = {RIGHTHALF_SX, RIGHTHALF_EX, MIDDLE_BOTTOM_LINE_SY,    MIDDLE_BOTTOM_LINE_EY,    BLUE};
RECT RIGHTHALF_LOWER_TOP        = {RIGHTHALF_SX, RIGHTHALF_EX, LOWER_TOP_LINE_SY,        LOWER_TOP_LINE_EY,        BLUE};
RECT RIGHTHALF_LOWER_BOTTOM     = {RIGHTHALF_SX, RIGHTHALF_EX, LOWER_BOTTOM_LINE_SY,     LOWER_BOTTOM_LINE_EY,     BLUE};
RECT RIGHTHALF_LOWERMOST_TOP    = {RIGHTHALF_SX, RIGHTHALF_EX, LOWERMOST_TOP_LINE_SY,    LOWERMOST_TOP_LINE_EY,    BLUE};
RECT RIGHTHALF_LOWERMOST_BOTTOM = {RIGHTHALF_SX, RIGHTHALF_EX, LOWERMOST_BOTTOM_LINE_SY, LOWERMOST_BOTTOM_LINE_EY, BLUE};
...
RECT LEFT_UPPERMOST_TOP      = {LEFTTHIRD_SX,    LEFTTHIRD_EX,      UPPERMOST_TOP_LINE_SY,    UPPERMOST_TOP_LINE_EY,    BLUE};
RECT LEFT_UPPERMOST_BOTTOM   = {LEFTTHIRD_SX,    LEFTTHIRD_EX,      UPPERMOST_BOTTOM_LINE_SY, UPPERMOST_BOTTOM_LINE_EY, BLUE};
RECT LEFT_UPPER_TOP          = {LEFTTHIRD_SX,    LEFTTHIRD_EX,      UPPER_TOP_LINE_SY,        UPPER_TOP_LINE_EY,        BLUE};
RECT LEFT_UPPER_BOTTOM       = {LEFTTHIRD_SX,    LEFTTHIRD_EX,      UPPER_BOTTOM_LINE_SY,     UPPER_BOTTOM_LINE_EY,     BLUE};
RECT LEFT_MIDDLE_TOP         = {LEFTTHIRD_SX,    LEFTTHIRD_EX,      MIDDLE_TOP_LINE_SY,       MIDDLE_TOP_LINE_EY,       BLUE};
RECT LEFT_MIDDLE_BOTTOM      = {LEFTTHIRD_SX,    LEFTTHIRD_EX,      MIDDLE_BOTTOM_LINE_SY,    MIDDLE_BOTTOM_LINE_EY,    BLUE};
RECT LEFT_LOWER_TOP          = {LEFTTHIRD_SX,    LEFTTHIRD_EX,      LOWER_TOP_LINE_SY,        LOWER_TOP_LINE_EY,        BLUE};
RECT LEFT_LOWER_BOTTOM       = {LEFTTHIRD_SX,    LEFTTHIRD_EX,      LOWER_BOTTOM_LINE_SY,     LOWER_BOTTOM_LINE_EY,     BLUE};
RECT LEFT_LOWERMOST_TOP      = {LEFTTHIRD_SX,    LEFTTHIRD_EX,      LOWERMOST_TOP_LINE_SY,    LOWERMOST_TOP_LINE_EY,    BLUE};
RECT LEFT_LOWERMOST_BOTTOM   = {LEFTTHIRD_SX,    LEFTTHIRD_EX,      LOWERMOST_BOTTOM_LINE_SY, LOWERMOST_BOTTOM_LINE_EY, BLUE};
RECT CENTER_UPPERMOST_TOP    = {CENTRALTHIRD_SX, CENTRALTHIRD_EX,   UPPERMOST_TOP_LINE_SY,    UPPERMOST_TOP_LINE_EY,    BLUE};
RECT CENTER_UPPERMOST_BOTTOM = {CENTRALTHIRD_SX, CENTRALTHIRD_EX,   UPPERMOST_BOTTOM_LINE_SY, UPPERMOST_BOTTOM_LINE_EY, BLUE};
RECT CENTER_UPPER_TOP        = {CENTRALTHIRD_SX, CENTRALTHIRD_EX,   UPPER_TOP_LINE_SY,        UPPER_TOP_LINE_EY,        BLUE};
RECT CENTER_UPPER_BOTTOM     = {CENTRALTHIRD_SX, CENTRALTHIRD_EX,   UPPER_BOTTOM_LINE_SY,     UPPER_BOTTOM_LINE_EY,     BLUE};
RECT CENTER_MIDDLE_TOP       = {CENTRALTHIRD_SX, CENTRALTHIRD_EX,   MIDDLE_TOP_LINE_SY,       MIDDLE_TOP_LINE_EY,       BLUE};
RECT CENTER_MIDDLE_BOTTOM    = {CENTRALTHIRD_SX, CENTRALTHIRD_EX,   MIDDLE_BOTTOM_LINE_SY,    MIDDLE_BOTTOM_LINE_EY,    BLUE};
RECT CENTER_LOWER_TOP        = {CENTRALTHIRD_SX, CENTRALTHIRD_EX,   LOWER_TOP_LINE_SY,        LOWER_TOP_LINE_EY,        BLUE};
RECT CENTER_LOWER_BOTTOM     = {CENTRALTHIRD_SX, CENTRALTHIRD_EX,   LOWER_BOTTOM_LINE_SY,     LOWER_BOTTOM_LINE_EY,     BLUE};
RECT CENTER_LOWERMOST_TOP    = {CENTRALTHIRD_SX, CENTRALTHIRD_EX,   LOWERMOST_TOP_LINE_SY,    LOWERMOST_TOP_LINE_EY,    BLUE};
RECT CENTER_LOWERMOST_BOTTOM = {CENTRALTHIRD_SX, CENTRALTHIRD_EX,   LOWERMOST_BOTTOM_LINE_SY, LOWERMOST_BOTTOM_LINE_EY, BLUE};
RECT RIGHT_UPPERMOST_TOP     = {RIGHTTHIRD_SX,   RIGHTTHIRD_EX,     UPPERMOST_TOP_LINE_SY,    UPPERMOST_TOP_LINE_EY,    BLUE};
RECT RIGHT_UPPERMOST_BOTTOM  = {RIGHTTHIRD_SX,   RIGHTTHIRD_EX,     UPPERMOST_BOTTOM_LINE_SY, UPPERMOST_BOTTOM_LINE_EY, BLUE};
RECT RIGHT_UPPER_TOP         = {RIGHTTHIRD_SX,   RIGHTTHIRD_EX,     UPPER_TOP_LINE_SY,        UPPER_TOP_LINE_EY,        BLUE};
RECT RIGHT_UPPER_BOTTOM      = {RIGHTTHIRD_SX,   RIGHTTHIRD_EX,     UPPER_BOTTOM_LINE_SY,     UPPER_BOTTOM_LINE_EY,     BLUE};
RECT RIGHT_MIDDLE_TOP        = {RIGHTTHIRD_SX,   RIGHTTHIRD_EX,     MIDDLE_TOP_LINE_SY,       MIDDLE_TOP_LINE_EY,       BLUE};
RECT RIGHT_MIDDLE_BOTTOM     = {RIGHTTHIRD_SX,   RIGHTTHIRD_EX,     MIDDLE_BOTTOM_LINE_SY,    MIDDLE_BOTTOM_LINE_EY,    BLUE};
RECT RIGHT_LOWER_TOP         = {RIGHTTHIRD_SX,   RIGHTTHIRD_EX,     LOWER_TOP_LINE_SY,        LOWER_TOP_LINE_EY,        BLUE};
RECT RIGHT_LOWER_BOTTOM      = {RIGHTTHIRD_SX,   RIGHTTHIRD_EX,     LOWER_BOTTOM_LINE_SY,     LOWER_BOTTOM_LINE_EY,     BLUE};
RECT RIGHT_LOWERMOST_TOP     = {RIGHTTHIRD_SX,   RIGHTTHIRD_EX,     LOWERMOST_TOP_LINE_SY,    LOWERMOST_TOP_LINE_EY,    BLUE};
RECT RIGHT_LOWERMOST_BOTTOM  = {RIGHTTHIRD_SX,   RIGHTTHIRD_EX,     LOWERMOST_BOTTOM_LINE_SY, LOWERMOST_BOTTOM_LINE_EY, BLUE};
...
RECT CENTER_LOWER     = {CENTRALTHIRD_SX, CENTRALTHIRD_EX, LOWER_LINE_SY,     LOWER_LINE_EY,     BLUE};
RECT LEFT_LOWERMOST   = {LEFTTHIRD_SX,    LEFTTHIRD_EX,    LOWERMOST_LINE_SY, LOWERMOST_LINE_EY, BLUE};
RECT CENTER_LOWERMOST = {CENTRALTHIRD_SX, CENTRALTHIRD_EX, LOWERMOST_LINE_SY, LOWERMOST_LINE_EY, BLUE};
RECT RIGHT_LOWERMOST  = {RIGHTTHIRD_SX,   RIGHTTHIRD_EX,   LOWERMOST_LINE_SY, LOWERMOST_LINE_EY, BLUE};

RECT ULLCONTROL = {LEFTMOSTFOURTH_SX,  LEFTMOSTFOURTH_EX,  UPPER_LINE_SY, MIDDLE_LINE_EY,    YELLOW};
RECT LLLCONTROL = {LEFTMOSTFOURTH_SX,  LEFTMOSTFOURTH_EX,  LOWER_LINE_SY, LOWERMOST_LINE_EY, YELLOW};
RECT ULCONTROL  = {LEFTFOURTH_SX,      LEFTFOURTH_EX,      UPPER_LINE_SY, MIDDLE_LINE_EY,    YELLOW};
RECT LLCONTROL  = {LEFTFOURTH_SX,      LEFTFOURTH_EX,      LOWER_LINE_SY, LOWERMOST_LINE_EY, YELLOW};
RECT URCONTROL  = {RIGHTFOURTH_SX,     RIGHTFOURTH_EX,     UPPER_LINE_SY, MIDDLE_LINE_EY,    YELLOW};
RECT LRCONTROL  = {RIGHTFOURTH_SX,     RIGHTFOURTH_EX,     LOWER_LINE_SY, LOWERMOST_LINE_EY, YELLOW};
RECT URRCONTROL = {RIGHTMOSTFOURTH_SX, RIGHTMOSTFOURTH_EX, UPPER_LINE_SY, MIDDLE_LINE_EY,    YELLOW};
RECT LRRCONTROL = {RIGHTMOSTFOURTH_SX, RIGHTMOSTFOURTH_EX, LOWER_LINE_SY, LOWERMOST_LINE_EY, YELLOW};

const RECT* CONTROLS[8] = {&ULLCONTROL, &ULCONTROL, &URCONTROL, &URRCONTROL, &LLLCONTROL, &LLCONTROL, &LRCONTROL, &LRRCONTROL};

RECT ULLCONTROL_TOP    = {LEFTMOSTFOURTH_SX,    LEFTMOSTFOURTH_EX,    UPPER_BOTTOM_LINE_SY-10,     UPPER_BOTTOM_LINE_EY-10,     YELLOW};
RECT ULLCONTROL_MIDDLE = {LEFTMOSTFOURTH_SX,    LEFTMOSTFOURTH_EX,    MIDDLE_TOP_LINE_SY-10,       MIDDLE_TOP_LINE_EY-10,       YELLOW};
RECT ULLCONTROL_BOTTOM = {LEFTMOSTFOURTH_SX+7,  LEFTMOSTFOURTH_EX-7,  MIDDLE_BOTTOM_LINE_SY-10,    MIDDLE_BOTTOM_LINE_EY-10,    YELLOW};
RECT LLLCONTROL_TOP    = {LEFTMOSTFOURTH_SX,    LEFTMOSTFOURTH_EX,    LOWER_BOTTOM_LINE_SY-10,     LOWER_BOTTOM_LINE_EY-10,     YELLOW};
RECT LLLCONTROL_MIDDLE = {LEFTMOSTFOURTH_SX,    LEFTMOSTFOURTH_EX,    LOWERMOST_TOP_LINE_SY-10,    LOWERMOST_TOP_LINE_EY-10,    YELLOW};
RECT LLLCONTROL_BOTTOM = {LEFTMOSTFOURTH_SX+7,  LEFTMOSTFOURTH_EX-7,  LOWERMOST_BOTTOM_LINE_SY-10, LOWERMOST_BOTTOM_LINE_EY-10, YELLOW};
RECT ULCONTROL_TOP     = {LEFTFOURTH_SX,        LEFTFOURTH_EX,        UPPER_BOTTOM_LINE_SY-10,     UPPER_BOTTOM_LINE_EY-10,     YELLOW};
RECT ULCONTROL_MIDDLE  = {LEFTFOURTH_SX,        LEFTFOURTH_EX,        MIDDLE_TOP_LINE_SY-10,       MIDDLE_TOP_LINE_EY-10,       YELLOW};
RECT ULCONTROL_BOTTOM  = {LEFTFOURTH_SX+7,      LEFTFOURTH_EX-7,      MIDDLE_BOTTOM_LINE_SY-10,    MIDDLE_BOTTOM_LINE_EY-10,    YELLOW};
RECT LLCONTROL_TOP     = {LEFTFOURTH_SX,        LEFTFOURTH_EX,        LOWER_BOTTOM_LINE_SY-10,     LOWER_BOTTOM_LINE_EY-10,     YELLOW};
RECT LLCONTROL_MIDDLE  = {LEFTFOURTH_SX,        LEFTFOURTH_EX,        LOWERMOST_TOP_LINE_SY-10,    LOWERMOST_TOP_LINE_EY-10,    YELLOW};
RECT LLCONTROL_BOTTOM  = {LEFTFOURTH_SX+7,      LEFTFOURTH_EX-7,      LOWERMOST_BOTTOM_LINE_SY-10, LOWERMOST_BOTTOM_LINE_EY-10, YELLOW};
RECT URCONTROL_TOP     = {RIGHTFOURTH_SX,       RIGHTFOURTH_EX,       UPPER_BOTTOM_LINE_SY-10,     UPPER_BOTTOM_LINE_EY-10,     YELLOW};
RECT URCONTROL_MIDDLE  = {RIGHTFOURTH_SX,       RIGHTFOURTH_EX,       MIDDLE_TOP_LINE_SY-10,       MIDDLE_TOP_LINE_EY-10,       YELLOW};
RECT URCONTROL_BOTTOM  = {RIGHTFOURTH_SX+7,     RIGHTFOURTH_EX-7,     MIDDLE_BOTTOM_LINE_SY-10,    MIDDLE_BOTTOM_LINE_EY-10,    YELLOW};
RECT LRCONTROL_TOP     = {RIGHTFOURTH_SX,       RIGHTFOURTH_EX,       LOWER_BOTTOM_LINE_SY-10,     LOWER_BOTTOM_LINE_EY-10,     YELLOW};
RECT LRCONTROL_MIDDLE  = {RIGHTFOURTH_SX,       RIGHTFOURTH_EX,       LOWERMOST_TOP_LINE_SY-10,    LOWERMOST_TOP_LINE_EY-10,    YELLOW};
RECT LRCONTROL_BOTTOM  = {RIGHTFOURTH_SX+7,     RIGHTFOURTH_EX-7,     LOWERMOST_BOTTOM_LINE_SY-10, LOWERMOST_BOTTOM_LINE_EY-10, YELLOW};
RECT URRCONTROL_TOP    = {RIGHTMOSTFOURTH_SX,   RIGHTMOSTFOURTH_EX,   UPPER_BOTTOM_LINE_SY-10,     UPPER_BOTTOM_LINE_EY-10,     YELLOW};
RECT URRCONTROL_MIDDLE = {RIGHTMOSTFOURTH_SX,   RIGHTMOSTFOURTH_EX,   MIDDLE_TOP_LINE_SY-10,       MIDDLE_TOP_LINE_EY-10,       YELLOW};
RECT URRCONTROL_BOTTOM = {RIGHTMOSTFOURTH_SX+7, RIGHTMOSTFOURTH_EX-7, MIDDLE_BOTTOM_LINE_SY-10,    MIDDLE_BOTTOM_LINE_EY-10,    YELLOW};
RECT LRRCONTROL_TOP    = {RIGHTMOSTFOURTH_SX,   RIGHTMOSTFOURTH_EX,   LOWER_BOTTOM_LINE_SY-10,     LOWER_BOTTOM_LINE_EY-10,     YELLOW};
RECT LRRCONTROL_MIDDLE = {RIGHTMOSTFOURTH_SX,   RIGHTMOSTFOURTH_EX,   LOWERMOST_TOP_LINE_SY-10,    LOWERMOST_TOP_LINE_EY-10,    YELLOW};
RECT LRRCONTROL_BOTTOM = {RIGHTMOSTFOURTH_SX+7, RIGHTMOSTFOURTH_EX-7, LOWERMOST_BOTTOM_LINE_SY-10, LOWERMOST_BOTTOM_LINE_EY-10, YELLOW};
...
RECT ULLCONTROL_IMAGE = {LEFTMOSTFOURTH_SX,  LEFTMOSTFOURTH_EX,  UPPER_BOTTOM_LINE_SY-10, MIDDLE_TOP_LINE_EY-10,    YELLOW};
RECT LLLCONTROL_IMAGE = {LEFTMOSTFOURTH_SX,  LEFTMOSTFOURTH_EX,  LOWER_BOTTOM_LINE_SY-10, LOWERMOST_TOP_LINE_EY-10, YELLOW};
RECT ULCONTROL_IMAGE  = {LEFTFOURTH_SX,      LEFTFOURTH_EX,      UPPER_BOTTOM_LINE_SY-10, MIDDLE_TOP_LINE_EY-10,    YELLOW};
RECT LLCONTROL_IMAGE  = {LEFTFOURTH_SX,      LEFTFOURTH_EX,      LOWER_BOTTOM_LINE_SY-10, LOWERMOST_TOP_LINE_EY-10, YELLOW};
RECT URCONTROL_IMAGE  = {RIGHTFOURTH_SX,     RIGHTFOURTH_EX,     UPPER_BOTTOM_LINE_SY-10, MIDDLE_TOP_LINE_EY-10,    YELLOW};
RECT LRCONTROL_IMAGE  = {RIGHTFOURTH_SX,     RIGHTFOURTH_EX,     LOWER_BOTTOM_LINE_SY-10, LOWERMOST_TOP_LINE_EY-10, YELLOW};
RECT URRCONTROL_IMAGE = {RIGHTMOSTFOURTH_SX, RIGHTMOSTFOURTH_EX, UPPER_BOTTOM_LINE_SY-10, MIDDLE_TOP_LINE_EY-10,    YELLOW};
RECT LRRCONTROL_IMAGE = {RIGHTMOSTFOURTH_SX, RIGHTMOSTFOURTH_EX, LOWER_BOTTOM_LINE_SY-10, LOWERMOST_TOP_LINE_EY-10, YELLOW};
...
RECT MESSAGEBOX         = {MESSAGEBOX_SX,         MESSAGEBOX_EX,         MESSAGEBOX_SY,         MESSAGEBOX_EY,         MESSAGEBOX_COLOR};
RECT MESSAGEBOX_LBUTTON = {MESSAGEBOX_LBUTTON_SX, MESSAGEBOX_LBUTTON_EX, MESSAGEBOX_BUTTONS_SY, MESSAGEBOX_BUTTONS_EY, MESSAGEBOX_COLOR};
RECT MESSAGEBOX_CBUTTON = {MESSAGEBOX_CBUTTON_SX, MESSAGEBOX_CBUTTON_EX, MESSAGEBOX_BUTTONS_SY, MESSAGEBOX_BUTTONS_EY, MESSAGEBOX_COLOR};
RECT MESSAGEBOX_RBUTTON = {MESSAGEBOX_RBUTTON_SX, MESSAGEBOX_RBUTTON_EX, MESSAGEBOX_BUTTONS_SY, MESSAGEBOX_BUTTONS_EY, MESSAGEBOX_COLOR};

RECT KEY_1 = {KEY_ROW_2_SX, KEY_ROW_2_EX, MIDDLE_LINE_SY,    MIDDLE_LINE_EY,    WHITE};
RECT KEY_2 = {KEY_ROW_3_SX, KEY_ROW_3_EX, MIDDLE_LINE_SY,    MIDDLE_LINE_EY,    WHITE};
RECT KEY_3 = {KEY_ROW_4_SX, KEY_ROW_4_EX, MIDDLE_LINE_SY,    MIDDLE_LINE_EY,    WHITE};
RECT KEY_M = {KEY_ROW_5_SX, KEY_ROW_5_EX, MIDDLE_LINE_SY,    MIDDLE_LINE_EY,    WHITE};
RECT KEY_B = {KEY_ROW_6_SX, KEY_ROW_6_EX, MIDDLE_LINE_SY,    MIDDLE_LINE_EY,    WHITE};
RECT KEY_C = {KEY_ROW_7_SX, KEY_ROW_7_EX, MIDDLE_LINE_SY,    MIDDLE_LINE_EY,    WHITE};
RECT KEY_4 = {KEY_ROW_2_SX, KEY_ROW_2_EX, LOWER_LINE_SY,     LOWER_LINE_EY,     WHITE};
RECT KEY_5 = {KEY_ROW_3_SX, KEY_ROW_3_EX, LOWER_LINE_SY,     LOWER_LINE_EY,     WHITE};
RECT KEY_6 = {KEY_ROW_4_SX, KEY_ROW_4_EX, LOWER_LINE_SY,     LOWER_LINE_EY,     WHITE};
RECT KEY_D = {KEY_ROW_5_SX, KEY_ROW_5_EX, LOWER_LINE_SY,     LOWER_LINE_EY,     WHITE};
RECT KEY_7 = {KEY_ROW_2_SX, KEY_ROW_2_EX, LOWERMOST_LINE_SY, LOWERMOST_LINE_EY, WHITE};
RECT KEY_8 = {KEY_ROW_3_SX, KEY_ROW_3_EX, LOWERMOST_LINE_SY, LOWERMOST_LINE_EY, WHITE};
RECT KEY_9 = {KEY_ROW_4_SX, KEY_ROW_4_EX, LOWERMOST_LINE_SY, LOWERMOST_LINE_EY, WHITE};
RECT KEY_0 = {KEY_ROW_5_SX, KEY_ROW_5_EX, LOWERMOST_LINE_SY, LOWERMOST_LINE_EY, WHITE};

RECT VALUE = {0, RESOLUTION_X-1, UPPER_LINE_SY, UPPER_LINE_EY, RED};

const char* PARAM_NAMES[] = {"Неизвестно", "Температура", "Влажность", "Давление", "Кислород", "Диоксид углерода", "Монооксид углерода", "Водород", "Метан", "Оксид азота", "Скорость потока", "Напряжение", "Темп. управления", "Аккумулятор", "Расход", "Управление O2", "Кол-во частиц (>0.3 мкм)", "Кол-во частиц (>0.5 мкм)", "Кол-во частиц (>5.0 мкм)", "Объем жидкости", "Аммиак", "Сероводород", "Уровень сигнала", "Плотность теплового потока", "ТНС", "Термосопротивление", "Дельта"};
...
{ 
  ...
  for(i = 0; i < n.quot; i++)
  {    
    read_opened_SDCard( (pU8)tftBuffer, 1);
    TFT_Load(tftBuffer, 256);
  }
  
  if(n.rem)
  {    
    read_opened_SDCard( (pU8)tftBuffer, 1);
    TFT_Load(tftBuffer, n.rem);
  }
...
void ScreenShoot(U32 SDaddress)
{
  ...
  { 
    for(U32 j = 0; j < 256;  j++)  tftBuffer[j] = read_tft_data();
    write_SDCard( (pU8)tftBuffer, SDaddress, 512);
  } 
}
...
void GUI_TouchMeasuresAll(Int16U X, Int16U Y)
{
  ...
  RECT* header_rect = &HEADER;
  Int8U channels_count = GetDisplayChannelsCount();
  if (channels_count > 8)
  {
    header_rect = &HEADER_WIDE;
    if (CurrentMeasuresPage == 0)
    {
...
void GUI_DrawMeasuresChannel()
{
  ...
  int first, second;
  Int16U font_color, color = (*BORDER_BUTTONS_UD[CurrentDisplay-CurrentMeasuresPage*8]).color;
  for (int i = CurrentMeasuresPage*8; i < CurrentMeasuresPage*8+8; i++)
  {
    if (CurrentDisplay == i)
    {
...
void GUI_UpdateMeasuresChannel()
{
  ...
  Int16U back_color = (*BORDER_BUTTONS_UD[CurrentDisplay-CurrentMeasuresPage*8]).color;
...
void GUI_TouchChannelSettingsCalculatePressureScreen()
{
  ...
  {
    set_sound(S_SOUND_20);
    GUI_KeyboardFloat(&DisplayConfig[CurrentDisplay].Constant[2], "Настройки", "Нижняя граница, кПа", false, 0, 999999, 0);
  ...
  {
    set_sound(S_SOUND_20);
    GUI_KeyboardFloat(&DisplayConfig[CurrentDisplay].Constant[3], "Настройки", "Верхняя граница, кПа", false, 0, 999999, 0);
    GUI_DrawChannelSettingsCalculatePressureScreen();
    return;
  }
}
...
void GUI_DrawParamRootScreen()
{
  char display[30];
  sprintf(display, "Канал %d", CurrentDisplay+1);
  //GUI_DrawHeader(BACK_60x60, true, BACKWARD_60x60, false, FORWARD_60x60, false, "Измерение", display);
  ...
  if (!BackToAllChannels) // пользователь зашёл из экрана канала
  {
    ...
    for (int i = start_rect; i < end_rect; i++)
    {
      ...
      /*else
      {
        Int16U font_color = (CurrentParam == first) || (CurrentParam == second) ? BROWN : BLACK;
        Int16U back_color = (*BORDER_BUTTONS_UD[CurrentDisplay-CurrentMeasuresPage*8]).color;
        TFT_FillRect_(*CAPTIONS_LR[i], back_color);
        GetParamName(CurrentDisplay, CurrentParam, display);
        TFT_WriteStringInRectCenter(display, font_color, back_color, *CAPTIONS_LR[i], 0, 0, &Tahoma34);
      }*/
    }
  }
...
void GUI_UpdateParamRootScreen()
{
  ...
  if (BackToAllChannels) // пользователь зашёл из общего экрана
  {
    ...
    if ((first != -1) && (second != -1))
    {
      if (CurrentParam == first)
      {
        back_color = LVALUES_UD[CurrentDisplay-CurrentMeasuresPage*8]->color;
        GetMeasureStringNoUnits(CurrentDisplay, first, display, &color);
        TFT_FillRect_(*LVALUES_UD[CurrentDisplay-CurrentMeasuresPage*8], back_color);
        TFT_WriteStringInRectCenter(display, color, back_color, *LVALUES_UD[CurrentDisplay-CurrentMeasuresPage*8], 0, 0, &Tahoma34);
      }
      if (CurrentParam == second)
      {
        back_color = RVALUES_UD[CurrentDisplay-CurrentMeasuresPage*8]->color;
        GetMeasureStringNoUnits(CurrentDisplay, second, display, &color);
        TFT_FillRect_(*RVALUES_UD[CurrentDisplay-CurrentMeasuresPage*8], back_color);
        TFT_WriteStringInRectCenter(display, color, back_color, *RVALUES_UD[CurrentDisplay-CurrentMeasuresPage*8], 0, 0, &Tahoma34);
      }
    }
    else if (first != -1)
    {
      back_color = VALUES_UD[CurrentDisplay-CurrentMeasuresPage*8]->color;
      GetMeasureStringNoUnits(CurrentDisplay, first, display, &color);
      TFT_FillRect_(*VALUES_UD[CurrentDisplay-CurrentMeasuresPage*8], back_color);
      TFT_WriteStringInRectCenter(display, color, back_color, *VALUES_UD[CurrentDisplay-CurrentMeasuresPage*8], 0, 0, &Tahoma34);
    }
  }
  if (!BackToAllChannels) // пользователь зашёл из экрана канала
  {
...
void GUI_UpdateControlRelayManualScreen()
{
  ...
  {
    TFT_WriteStringInRectCenter("ЗАМКНУТО", BROWN, EVEN_GREEN, RIGHTHALF_MIDDLE_TOP, 0, 0, &Tahoma34);
    GUI_DrawImageInRectCenterSwapColor(RELAY_UP_60x60, CENTER_LOWER, TEMPLATE_COLOR, ODD_GREEN);
  }
  else
  {
    TFT_WriteStringInRectCenter("РАЗОМКНУТО", BROWN, EVEN_GREEN, RIGHTHALF_MIDDLE_TOP, 0, 0, &Tahoma34);
...
void GUI_UpdateControlRelayLogicScreen()
{
  ...
  if ((RelayOuts >> CurrentControl) & 1)
    TFT_WriteStringInRectCenter("ЗАМКНУТО", BROWN, EVEN_GREEN, RIGHTHALF_LOWERMOST_TOP, 0, 0, &Tahoma34);
  else
    TFT_WriteStringInRectCenter("РАЗОМКНУТО", BROWN, EVEN_GREEN, RIGHTHALF_LOWERMOST_TOP, 0, 0, &Tahoma34);
}
...
void GUI_UpdateControlRelayHesterProgrammScreen()
{
  ...
  if ((RelayOuts >> CurrentControl) & 1)
    TFT_WriteStringInRectCenter("ЗАМКНУТО", BROWN, EVEN_GREEN, RIGHTHALF_LOWER_BOTTOM, 0, 0, &Tahoma34);
  else
    TFT_WriteStringInRectCenter("РАЗОМКНУТО", BROWN, EVEN_GREEN, RIGHTHALF_LOWER_BOTTOM, 0, 0, &Tahoma34);
...
void GUI_DrawRelayConfigurationHesterScreen()
{
  ...
  TFT_WriteStringInRectLeft("Использовать программму", BLACK, BACKGROUND_COLOR, LEFT_TWOTHIRDS_LOWERMOST, 5, 0, &Tahoma34);
...
void GUI_TouchRelayConfigurationHesterScreen()
{
  ...
  {
    set_sound(S_SOUND_20);
    GUI_KeyboardFloat(&OutConfig[CurrentControl].DefParam, "Настройки", "Параметр", false, min, max, decimal);
...
void GUI_DrawSettingsConnectionScreen()
{
  ...
  TFT_WriteStringInRectCenter("RS-232/RS-485", DARKGREEN, BACKGROUND_COLOR, UPPER, 0, 0, &Tahoma34);
  TFT_UnderlineRect_Offset(UPPER, BLACK, 1, 40, 0);
  ...
  {
    TFT_WriteStringInRectCenter("TCP/IP", DARKGREEN, BACKGROUND_COLOR, MIDDLE, 0, 0, &Tahoma34);
    TFT_UnderlineRect_Offset(MIDDLE, BLACK, 1, 40, 0);
    ...
    sprintf(display, "%.2x:%.2x:%.2x:%.2x:%.2x:%.2x", MAC[0], MAC[1], MAC[2], MAC[3], MAC[4], MAC[5]);
    TFT_WriteStringInRectLeft("MAC-адрес", BLACK, BACKGROUND_COLOR, LEFTHALF_LOWERMOST_BOTTOM, 5, 0, &Tahoma34);
    TFT_WriteStringInRectCenter(display, BROWN, BACKGROUND_COLOR, RIGHTHALF_LOWERMOST_BOTTOM, 0, 0, &Tahoma34);
  }
...
{
  GUI_DrawHeaderWide(OK_60x60, true, "Настройки", "RS-232/RS-485");
...
{
  GUI_DrawHeaderWide(BACK_60x60, true, "Настройки", "TCP/IP");
...
void GUI_TouchSettingsStatisticScreen()
{
  ...
  {
    set_sound(S_SOUND_20);
    if (GUI_KeyboardInt(&StatisticPeriod, "Настройки", "Период статистики", true, 1, 6000))
    {
      OS_Use(&SemaRAM);
  ...
  {
    set_sound(S_SOUND_20);
    if (GUI_MessageBox("Подтверждение", "Очистить память статистики?", "Это действие не может быть", "отменено.", 0, MESSAGEBOX_YESNO, BACKGROUND_COLOR))
    {
...
void GUI_TouchSettingsOtherScreen1()
{
  ...
  {
    set_sound(S_SOUND_20);
    if (GUI_MessageBox("Подтверждение", "Востановить заводские", "установки?", "", 0, MESSAGEBOX_YESNO, BACKGROUND_COLOR))
    {
      OS_Use( &SemaRAM);
...
{   
  ...
  write_tft_data( 0x60 * Brightness / 100. + 0x08);  // duty cycle pwm
  write_tft_data( 0x01);  // dbc control pwm
...
void TFT_Task(void) 
{
  ...
  while (1)
  {
    ...
    if ((update_counter++ % 20 == 0) && update) update();
