...
#define MESSAGEBOX_SX                     0
#define MESSAGEBOX_EX                     239
#define MESSAGEBOX_SY                     75
#define MESSAGEBOX_EY                     244
#define MESSAGEBOX_COLOR                  RGB565(250, 228, 163)
#define MESSAGEBOX_HEAD_COLOR             RGB565(230, 208, 143)
#define MESSAGEBOX_CAPTION_SX             10
#define MESSAGEBOX_CAPTION_SY             MESSAGEBOX_SY
#define MESSAGEBOX_LINES_SX               5
...
void GUI_DrawParamScreen();
void GUI_UpdateParamScreen();
void GUI_TouchParamScreen();
...
void GUI_DrawSettingsOtherScreen();
void GUI_UpdateSettingsOtherScreen();
void GUI_TouchSettingsOtherScreen();
