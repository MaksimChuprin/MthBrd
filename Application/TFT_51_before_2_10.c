...
const RECT* ULPARAMS_UD_BIG[4]   = {&ULLPARAM,   &LLLPARAM,    &URLPARAM,   &LRLPARAM};
const RECT* ULCAPTIONS_UD_BIG[4] = {&ULLCAPTION, &LLLCAPTION,  &URLCAPTION, &LRLCAPTION};
const RECT* ULVALUES_UD_BIG[4]   = {&ULLVALUE,   &LLLVALUE,    &URLVALUE,   &LRLVALUE};
const RECT* URPARAMS_UD_BIG[4]   = {&ULRPARAM,   &LLRPARAM,    &URRPARAM,   &LRRPARAM};
const RECT* URCAPTIONS_UD_BIG[4] = {&ULRCAPTION, &LLRCAPTION,  &URRCAPTION, &LRRCAPTION};
const RECT* URVALUES_UD_BIG[4]   = {&ULRVALUE,   &LLRVALUE,    &URRVALUE,   &LRRVALUE};
const RECT* LLPARAMS_UD_BIG[4]   = {&LLLPARAM,   &LMLLPARAM,   &MRLPARAM,   &LMRLPARAM};
const RECT* LLCAPTIONS_UD_BIG[4] = {&LLLCAPTION, &LMLLCAPTION, &MRLCAPTION, &LMRLCAPTION};
const RECT* LLVALUES_UD_BIG[4]   = {&LLLVALUE,   &LMLLVALUE,   &MRLVALUE,   &LMRLVALUE};
const RECT* LRPARAMS_UD_BIG[4]   = {&LLRPARAM,   &LMLRPARAM,   &MRRPARAM,   &LMRRPARAM};
const RECT* LRCAPTIONS_UD_BIG[4] = {&LLRCAPTION, &LMLRCAPTION, &MRRCAPTION, &LMRRCAPTION};
const RECT* LRVALUES_UD_BIG[4]   = {&LLRVALUE,   &LMLRVALUE,   &MRRVALUE,   &LMRRVALUE};
...
void GUI_TouchMeasuresScreen()
{
  ...
  if (CurrentDisplay == 255)
  {
    if (channels_count > 4)
    {
      GUI_TouchMeasuresChannels8(X, Y);
    }
    else if (channels_count > 1)
    {
  ...
  for (int i = CurrentMeasuresPage*8; i < CurrentMeasuresPage*8+8; i++)
  {
    ...
    if ((first != -1) && (second != -1))
    {
      if (TFT_CoordsInRect(X, Y, *LPARAMS_UD[i-CurrentMeasuresPage*8]))
      {
        ...
        GUI_SetGUI(GUI_DrawParamRootScreen8, GUI_UpdateParamRootScreen8, GUI_TouchParamRootScreen8);
        return;
      }
...
void GUI_DrawMeasuresChannels4()
{
  ...
  for (int i = 0; i < 4; i++)
  {
    ...
    if (params_on_mainscreen_count == 4)
    {
      GetParamTypeAndUnits(i, GetActiveBitIndex(params_on_mainscreen_mask, 0), display);
      TFT_WriteStringInRectCenter(display, BLACK, (*PARAMS_UD_BIG[i]).color, *ULCAPTIONS_UD_BIG[i], 0, 0, &Tahoma34);
      
      GetParamTypeAndUnits(i, GetActiveBitIndex(params_on_mainscreen_mask, 1), display);
      TFT_WriteStringInRectCenter(display, BLACK, (*PARAMS_UD_BIG[i]).color, *URCAPTIONS_UD_BIG[i], 0, 0, &Tahoma34);
      
      GetParamTypeAndUnits(i, GetActiveBitIndex(params_on_mainscreen_mask, 2), display);
      TFT_WriteStringInRectCenter(display, BLACK, (*PARAMS_UD_BIG[i]).color, *LLCAPTIONS_UD_BIG[i], 0, 0, &Tahoma34);
      
      GetParamTypeAndUnits(i, GetActiveBitIndex(params_on_mainscreen_mask, 3), display);
      TFT_WriteStringInRectCenter(display, BLACK, (*PARAMS_UD_BIG[i]).color, *LRCAPTIONS_UD_BIG[i], 0, 0, &Tahoma34);
    }
    if (params_on_mainscreen_count == 3)
    {
      GetParamTypeAndUnits(i, GetActiveBitIndex(params_on_mainscreen_mask, 0), display);
      TFT_WriteStringInRectCenter(display, BLACK, (*PARAMS_UD_BIG[i]).color, *ULCAPTIONS_UD_BIG[i], 0, 0, &Tahoma34);
      ...
      GetParamTypeAndUnits(i, GetActiveBitIndex(params_on_mainscreen_mask, 2), display);
      TFT_WriteStringInRectCenter(display, BLACK, (*PARAMS_UD_BIG[i]).color, *LCAPTIONS_UD_BIG[i], 0, 0, &Tahoma34);
    }
    if (params_on_mainscreen_count == 2)
    {
      GetParamNameAndUnits(i, GetActiveBitIndex(params_on_mainscreen_mask, 0), display);
      TFT_WriteStringInRectCenter(display, BLACK, (*PARAMS_UD_BIG[i]).color, *UCAPTIONS_UD_BIG[i], 0, 0, &Tahoma34);
        
      GetParamNameAndUnits(i, GetActiveBitIndex(params_on_mainscreen_mask, 1), display);
      TFT_WriteStringInRectCenter(display, BLACK, (*PARAMS_UD_BIG[i]).color, *LCAPTIONS_UD_BIG[i], 0, 0, &Tahoma34);
    }
    if (params_on_mainscreen_count == 1)
    {
      GetParamNameAndUnits(i, GetActiveBitIndex(params_on_mainscreen_mask, 0), display);
      TFT_WriteStringInRectCenter(display, BLACK, (*PARAMS_UD_BIG[i]).color, *CAPTIONS_UD_BIG[i], 0, 0, &Tahoma34);
    }
  }
...
void GUI_UpdateMeasuresChannels4()
{
  ...
  for (int i = 0; i < 4; i++)
  {
    ...
    if (params_on_mainscreen_count == 4)
    {
      GetMeasureStringNoUnits(i, GetActiveBitIndex(params_on_mainscreen_mask, 0), display, &color);
      TFT_FillRect_(*ULVALUES_UD_BIG[i], (*PARAMS_UD_BIG[i]).color);
      TFT_WriteStringInRectCenter(display, color, (*PARAMS_UD_BIG[i]).color, *ULVALUES_UD_BIG[i], 0, 0, &Tahoma34);
      
      GetMeasureStringNoUnits(i, GetActiveBitIndex(params_on_mainscreen_mask, 1), display, &color);
      TFT_FillRect_(*URVALUES_UD_BIG[i], (*PARAMS_UD_BIG[i]).color);
      TFT_WriteStringInRectCenter(display, color, (*PARAMS_UD_BIG[i]).color, *URVALUES_UD_BIG[i], 0, 0, &Tahoma34);
      
      GetMeasureStringNoUnits(i, GetActiveBitIndex(params_on_mainscreen_mask, 2), display, &color);
      TFT_FillRect_(*LLVALUES_UD_BIG[i], (*PARAMS_UD_BIG[i]).color);
      TFT_WriteStringInRectCenter(display, color, (*PARAMS_UD_BIG[i]).color, *LLVALUES_UD_BIG[i], 0, 0, &Tahoma34);
      
      GetMeasureStringNoUnits(i, GetActiveBitIndex(params_on_mainscreen_mask, 3), display, &color);
      TFT_FillRect_(*LRVALUES_UD_BIG[i], (*PARAMS_UD_BIG[i]).color);
      TFT_WriteStringInRectCenter(display, color, (*PARAMS_UD_BIG[i]).color, *LRVALUES_UD_BIG[i], 0, 0, &Tahoma34);
    }
    if (params_on_mainscreen_count == 3)
    {
      GetMeasureStringNoUnits(i, GetActiveBitIndex(params_on_mainscreen_mask, 0), display, &color);
      ...
      GetMeasureStringNoUnits(i, GetActiveBitIndex(params_on_mainscreen_mask, 2), display, &color);
      TFT_FillRect_(*LVALUES_UD_BIG[i], (*PARAMS_UD_BIG[i]).color);
      TFT_WriteStringInRectCenter(display, color, (*PARAMS_UD_BIG[i]).color, *LVALUES_UD_BIG[i], 0, 0, &Tahoma34);
    }
    if (params_on_mainscreen_count == 2)
    {
      GetMeasureStringNoUnits(i, GetActiveBitIndex(params_on_mainscreen_mask, 0), display, &color);
      TFT_FillRect_(*UVALUES_UD_BIG[i], (*PARAMS_UD_BIG[i]).color);
      TFT_WriteStringInRectCenter(display, color, (*PARAMS_UD_BIG[i]).color, *UVALUES_UD_BIG[i], 0, 0, &Tahoma34);
    ...
    {
      GetMeasureStringNoUnits(i, GetActiveBitIndex(params_on_mainscreen_mask, 0), display, &color);
      TFT_FillRect_(*VALUES_UD_BIG[i], (*PARAMS_UD_BIG[i]).color);
      TFT_WriteStringInRectCenter(display, color, (*PARAMS_UD_BIG[i]).color, *VALUES_UD_BIG[i], 0, 0, &Tahoma34);
    }
  }
}
...
void GUI_TouchMeasuresChannels4(Int16U X, Int16U Y)
{
  ...
  for (int i = 0; i < 4; i++)
  {
    ...
    if (params_on_mainscreen_count == 4)
    {
      if (TFT_CoordsInRect(X, Y, *ULPARAMS_UD_BIG[i]))
      {
        set_sound(S_SOUND_20);
        CurrentDisplay = i;
        CurrentParam = GetActiveBitIndex(params_on_mainscreen_mask, 0);
        BackToAllChannels = true;
        GUI_SetGUI(GUI_DrawParamRootScreen4, GUI_UpdateParamRootScreen4, GUI_TouchParamRootScreen4);
        return;
      }

      if (TFT_CoordsInRect(X, Y, *URPARAMS_UD_BIG[i]))
      {
        set_sound(S_SOUND_20);
        CurrentDisplay = i;
        CurrentParam = GetActiveBitIndex(params_on_mainscreen_mask, 1);
        BackToAllChannels = true;
        GUI_SetGUI(GUI_DrawParamRootScreen4, GUI_UpdateParamRootScreen4, GUI_TouchParamRootScreen4);
        return;
      }
      
      if (TFT_CoordsInRect(X, Y, *LLPARAMS_UD_BIG[i]))
      {
        set_sound(S_SOUND_20);
        CurrentDisplay = i;
        CurrentParam = GetActiveBitIndex(params_on_mainscreen_mask, 2);
        BackToAllChannels = true;
        GUI_SetGUI(GUI_DrawParamRootScreen4, GUI_UpdateParamRootScreen4, GUI_TouchParamRootScreen4);
        return;
      }
      
      if (TFT_CoordsInRect(X, Y, *LRPARAMS_UD_BIG[i]))
      {
        set_sound(S_SOUND_20);
        CurrentDisplay = i;
        CurrentParam = GetActiveBitIndex(params_on_mainscreen_mask, 3);
        BackToAllChannels = true;
        GUI_SetGUI(GUI_DrawParamRootScreen4, GUI_UpdateParamRootScreen4, GUI_TouchParamRootScreen4);
        return;
      }
...
void GUI_DrawMeasuresChannel4()
{
  ...
  for (int j = 0; j < params_count; j++)
  {
    ...
    font_color = (params_on_mainscreen_mask & (1 << j)) ? BROWN : BLACK;
    int k = DisplayConfig[CurrentDisplay].ParamConfig[j] & PARAM_PLACEMENT_MASK;
    if (k >= 12) k = 11;
    RECT placement = *CAPTIONS_LR[k];
    TFT_WriteStringInRectCenter(display, font_color, color, placement, 0, 0, &Tahoma34);
...
void GUI_DrawChannelSettingsCalculateHumidityScreen()
{
  ...
  //GUI_DrawHeaderMainButton(OK_60x60, true);
  //GUI_DrawHeaderLRButtons(BACKWARD_60x60, false, FORWARD_60x60, false);
  ...
  if (BackToAllChannels)
  {
    ...
    if (params_on_mainscreen_count == 2)
    {
      ...
      if (CurrentParam == GetActiveBitIndex(params_on_mainscreen_mask, 0))
      {
        ...
        GetMeasureStringNoUnits(CurrentDisplay, GetActiveBitIndex(params_on_mainscreen_mask, 0), display, &color);
      ...
      if (CurrentParam == GetActiveBitIndex(params_on_mainscreen_mask, 1))
      {
        ...
        GetMeasureStringNoUnits(CurrentDisplay, GetActiveBitIndex(params_on_mainscreen_mask, 1), display, &color);
    ...
    for (int i = 0; i < 4; i++)
    {
      if (CurrentDisplay == i)
      {
        ...
        if (params_on_mainscreen_count == 4)
        {
          if (CurrentParam != GetActiveBitIndex(params_on_mainscreen_mask, 0))
          {
            TFT_GrayoutRect_(*ULPARAMS_UD_BIG[i], BACKGROUND_COLOR);
          }
          if (CurrentParam != GetActiveBitIndex(params_on_mainscreen_mask, 1))
          {
            TFT_GrayoutRect_(*URPARAMS_UD_BIG[i], BACKGROUND_COLOR);
          }
          if (CurrentParam != GetActiveBitIndex(params_on_mainscreen_mask, 2))
          {
            TFT_GrayoutRect_(*LLPARAMS_UD_BIG[i], BACKGROUND_COLOR);
          }
          if (CurrentParam != GetActiveBitIndex(params_on_mainscreen_mask, 3))
          {
            TFT_GrayoutRect_(*LRPARAMS_UD_BIG[i], BACKGROUND_COLOR);
          }
        }
        if (params_on_mainscreen_count == 3)
        {
...
void GUI_UpdateParamRootScreen4()
{
  ...
  if (BackToAllChannels)
  {
    ...
    if (params_on_mainscreen_count == 4)
    {
      ...
      {
        GetMeasureStringNoUnits(CurrentDisplay, GetActiveBitIndex(params_on_mainscreen_mask, 0), display, &color);
        TFT_FillRect_(*ULVALUES_UD_BIG[CurrentDisplay], (*PARAMS_UD_BIG[CurrentDisplay]).color);
        TFT_WriteStringInRectCenter(display, color, (*PARAMS_UD_BIG[CurrentDisplay]).color, *ULVALUES_UD_BIG[CurrentDisplay], 0, 0, &Tahoma34);
      }
      if (CurrentParam == GetActiveBitIndex(params_on_mainscreen_mask, 1))
      {
        GetMeasureStringNoUnits(CurrentDisplay, GetActiveBitIndex(params_on_mainscreen_mask, 1), display, &color);
        TFT_FillRect_(*URVALUES_UD_BIG[CurrentDisplay], (*PARAMS_UD_BIG[CurrentDisplay]).color);
        TFT_WriteStringInRectCenter(display, color, (*PARAMS_UD_BIG[CurrentDisplay]).color, *URVALUES_UD_BIG[CurrentDisplay], 0, 0, &Tahoma34);
      }
      if (CurrentParam == GetActiveBitIndex(params_on_mainscreen_mask, 2))
      {
        GetMeasureStringNoUnits(CurrentDisplay, GetActiveBitIndex(params_on_mainscreen_mask, 2), display, &color);
        TFT_FillRect_(*LLVALUES_UD_BIG[CurrentDisplay], (*PARAMS_UD_BIG[CurrentDisplay]).color);
        TFT_WriteStringInRectCenter(display, color, (*PARAMS_UD_BIG[CurrentDisplay]).color, *LLVALUES_UD_BIG[CurrentDisplay], 0, 0, &Tahoma34);
      }
      if (CurrentParam == GetActiveBitIndex(params_on_mainscreen_mask, 3))
      {
        GetMeasureStringNoUnits(CurrentDisplay, GetActiveBitIndex(params_on_mainscreen_mask, 3), display, &color);
        TFT_FillRect_(*LRVALUES_UD_BIG[CurrentDisplay], (*PARAMS_UD_BIG[CurrentDisplay]).color);
        TFT_WriteStringInRectCenter(display, color, (*PARAMS_UD_BIG[CurrentDisplay]).color, *LRVALUES_UD_BIG[CurrentDisplay], 0, 0, &Tahoma34);
      }
    }
    if (params_on_mainscreen_count == 3)
    {
      ...
      {
        GetMeasureStringNoUnits(CurrentDisplay, GetActiveBitIndex(params_on_mainscreen_mask, 2), display, &color);
        TFT_FillRect_(*LVALUES_UD_BIG[CurrentDisplay], (*PARAMS_UD_BIG[CurrentDisplay]).color);
        TFT_WriteStringInRectCenter(display, color, (*PARAMS_UD_BIG[CurrentDisplay]).color, *LVALUES_UD_BIG[CurrentDisplay], 0, 0, &Tahoma34);
      }
    }
    if (params_on_mainscreen_count == 2)
    {
      ...
      {
        GetMeasureStringNoUnits(CurrentDisplay, GetActiveBitIndex(params_on_mainscreen_mask, 0), display, &color);
        TFT_FillRect_(*UVALUES_UD_BIG[CurrentDisplay], (*PARAMS_UD_BIG[CurrentDisplay]).color);
        TFT_WriteStringInRectCenter(display, color, (*PARAMS_UD_BIG[CurrentDisplay]).color, *UVALUES_UD_BIG[CurrentDisplay], 0, 0, &Tahoma34);
      }
      if (CurrentParam == GetActiveBitIndex(params_on_mainscreen_mask, 1))
      {
        GetMeasureStringNoUnits(CurrentDisplay, GetActiveBitIndex(params_on_mainscreen_mask, 1), display, &color);
    ...
    {
      GetMeasureStringNoUnits(CurrentDisplay, GetActiveBitIndex(params_on_mainscreen_mask, 0), display, &color);
      TFT_FillRect_(*VALUES_UD_BIG[CurrentDisplay], (*PARAMS_UD_BIG[CurrentDisplay]).color);
      TFT_WriteStringInRectCenter(display, color, (*PARAMS_UD_BIG[CurrentDisplay]).color, *VALUES_UD_BIG[CurrentDisplay], 0, 0, &Tahoma34);
    }
  }
  if (!BackToAllChannels)
  {
    ...
    if (k >= 12) k = 11;
    RECT placement = *VALUES_LR[k];
    TFT_FillRect_(placement, (*BORDER_BUTTONS_UD_BIG[CurrentDisplay]).color);
    TFT_WriteStringInRectCenter(display, color, (*BORDER_BUTTONS_UD_BIG[CurrentDisplay]).color, placement, 0, 0, &Tahoma34);
  }
}
