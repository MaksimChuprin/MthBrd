...
#define CALBRTFT                (U32)(((float)((float)PIXEL_CLOCK * 128) / (float)PLL_FREQ) * 8192) 
#define LCDC_FPR                (U32)(CALBRTFT - 1)
...
#define LEFT_LEFTMOST_QUARTER_SX    0
#define LEFT_LEFTMOST_QUARTER_EX    99
#define LEFT_MIDDLELEFT_QUARTER_SX  100
#define LEFT_MIDDLELEFT_QUARTER_EX  199
#define LEFT_MIDDLERIGHT_QUARTER_SX 200
#define LEFT_MIDDLERIGHT_QUARTER_EX 299
#define LEFT_RIGHTMOST_QUARTER_SX   300
#define LEFT_RIGHTMOST_QUARTER_EX   399

#define LEFT_PARAMS_SX              100
#define LEFT_PARAMS_EX              449
#define RIGHT_PARAMS_SX             450
#define RIGHT_PARAMS_EX             799

#define HEADER_LEFT_BUTTON_SX       100
#define HEADER_LEFT_BUTTON_EX       249
#define HEADER_RIGHT_BUTTON_SX      250
#define HEADER_RIGHT_BUTTON_EX      399
...
#define MEASURE_SCREEN_60x60     38
#define CONTROL_SCREEN_60x60     39
...
void GUI_DrawHeader4B(Int8U leftmost_button_image, bool leftmost_button_active, Int8U middleleft_button_image, bool middleleft_button_active, Int8U middleright_button_image, bool middleright_button_active, Int8U rightmost_button_image, bool rightmost_button_active, char* topic, char* title);
void GUI_DrawHeader2B(Int8U lefthalf_button_image, bool lefthalf_button_active, Int8U righthalf_button_image, bool righthalf_button_active, char* topic, char* title);
void GUI_DrawHeaderWide(Int8U leftmost_button_image, bool leftmost_button_active, Int8U middleleft_button_image, bool middleleft_button_active, char* topic, char* title);

void GUI_DrawHeaderLeftmostButton(Int8U leftmost_button_image, bool leftmost_button_active);
void GUI_DrawHeaderMiddleleftButton(Int8U middleleft_button_image, bool middleleft_button_active);
void GUI_DrawHeaderLefthalfButton(Int8U lefthalf_button_image, bool lefthalf_button_active);
void GUI_DrawHeaderRighthalfButton(Int8U righthalf_button_image, bool righthalf_button_active);
void GUI_DrawHeaderLeftButtons(Int8U leftmost_button_image, bool leftmost_button_active, Int8U middleleft_button_image, bool middleleft_button_active);
void GUI_DrawHeaderMiddlerightButton(Int8U middleright_button_image, bool middleright_button_active);
void GUI_DrawHeaderRightmostButton(Int8U rightmost_button_image, bool rightmost_button_active);
void GUI_DrawHeaderRightButtons(Int8U middleright_button_image, bool middleright_button_active, Int8U rightmost_button_image, bool rightmost_button_active);
...
#define WR_TFT_LOW              GPIOx_RESET(GPIOD, 1)
