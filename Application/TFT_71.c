...
const RECT HEAD_LEFTMOST_BUTTON    = {LEFT_LEFTMOST_QUARTER_SX,    LEFT_LEFTMOST_QUARTER_EX,    UPPERMOST_LINE_SY,        UPPERMOST_LINE_EY,        EVEN_YELLOW};
const RECT HEAD_MIDDLELEFT_BUTTON  = {LEFT_MIDDLELEFT_QUARTER_SX,  LEFT_MIDDLELEFT_QUARTER_EX,  UPPERMOST_LINE_SY,        UPPERMOST_LINE_EY,        EVEN_YELLOW};
const RECT HEAD_MIDDLERIGHT_BUTTON = {LEFT_MIDDLERIGHT_QUARTER_SX, LEFT_MIDDLERIGHT_QUARTER_EX, UPPERMOST_LINE_SY,        UPPERMOST_LINE_EY,        EVEN_YELLOW/*SHIFTED_EVEN_YELLOW*/};
const RECT HEAD_RIGHTMOST_BUTTON   = {LEFT_RIGHTMOST_QUARTER_SX,   LEFT_RIGHTMOST_QUARTER_EX,   UPPERMOST_LINE_SY,        UPPERMOST_LINE_EY,        EVEN_YELLOW/*SHIFTED_EVEN_YELLOW*/};
const RECT HEAD_LEFTHALF_BUTTON    = {LEFT_LEFTMOST_QUARTER_SX,    LEFT_MIDDLELEFT_QUARTER_EX,  UPPERMOST_LINE_SY,        UPPERMOST_LINE_EY,        EVEN_YELLOW};
const RECT HEAD_RIGHTHALF_BUTTON   = {LEFT_MIDDLERIGHT_QUARTER_SX, LEFT_RIGHTMOST_QUARTER_EX,   UPPERMOST_LINE_SY,        UPPERMOST_LINE_EY,        EVEN_YELLOW};
...
const RECT HEADER_WIDE     = {LEFT_MIDDLERIGHT_QUARTER_SX,  RIGHTHALF_EX,             UPPERMOST_LINE_SY,        UPPERMOST_LINE_EY,        BACKGROUND_COLOR};
const RECT TOPIC_WIDE      = {LEFT_MIDDLERIGHT_QUARTER_SX,  RIGHT_COLUMN_SX-1,        UPPERMOST_TOP_LINE_SY,    UPPERMOST_TOP_LINE_EY,    ODD_GRAY};
const RECT TITLE_WIDE      = {LEFT_MIDDLERIGHT_QUARTER_SX,  RIGHTHALF_EX,             UPPERMOST_BOTTOM_LINE_SY, UPPERMOST_BOTTOM_LINE_EY, EVEN_GRAY};
...
/* скриншортпобери */
static inline void ScreenShoot(U32 SDaddress)
{
  div_t       n;
  U32         i;
...
void TFT_DrawImage(Int32U* data_addr, Int16U sX, Int16U sY, Int16U width, Int16U height)
{
  ...
  if ((sX >= RESOLUTION_X) || (eX >= RESOLUTION_X) || (sY >= RESOLUTION_Y) || (eY >= RESOLUTION_Y)) return;
...
{
  GUI_DrawHeader2B(OK_60x60, true, CANCEL_60x60, true, topic, title);
...
bool GUI_KeyboardChar(char* value, char* topic, char* title, bool is_unsigned, bool is_float, bool is_ip)
{
  ...
  while (1)
  {
    ...
    if (TFT_CoordsInRect(X, Y, HEAD_LEFTHALF_BUTTON))
    {
      set_sound(S_SOUND_20);
      return true;
    }
    
    if (TFT_CoordsInRect(X, Y, HEAD_RIGHTHALF_BUTTON))
    {
      set_sound(S_SOUND_20);
      return false;
    }
...
{
  GUI_DrawHeaderLeftButtons(leftmost_button_image, leftmost_button_active, middleleft_button_image, middleleft_button_active);
  GUI_DrawHeaderRightButtons(middleright_button_image, middleright_button_active, rightmost_button_image, rightmost_button_active);
...
{
  GUI_DrawHeaderLefthalfButton(lefthalf_button_image, lefthalf_button_active);
  GUI_DrawHeaderRighthalfButton(righthalf_button_image, righthalf_button_active);
...
{
  TFT_FillRect_Offset(HEAD_LEFTMOST_BUTTON, HEAD_LEFTMOST_BUTTON.color, 0, 0);
  if (leftmost_button_image != NO_IMAGE)
    GUI_DrawImageInRectCenterSwapColor(leftmost_button_image, HEAD_LEFTMOST_BUTTON, TEMPLATE_COLOR, HEAD_LEFTMOST_BUTTON.color);
  if (!leftmost_button_active)
    TFT_GrayoutRect_(HEAD_LEFTMOST_BUTTON, BACKGROUND_COLOR);
}

void GUI_DrawHeaderLefthalfButton(Int8U lefthalf_button_image, bool lefthalf_button_active)
{
  TFT_FillRect_Offset(HEAD_LEFTHALF_BUTTON, HEAD_LEFTHALF_BUTTON.color, 0, 0);
  if (lefthalf_button_image != NO_IMAGE)
    GUI_DrawImageInRectCenterSwapColor(lefthalf_button_image, HEAD_LEFTHALF_BUTTON, TEMPLATE_COLOR, HEAD_LEFTHALF_BUTTON.color);
  if (!lefthalf_button_active)
    TFT_GrayoutRect_(HEAD_LEFTHALF_BUTTON, BACKGROUND_COLOR);
}

void GUI_DrawHeaderRighthalfButton(Int8U righthalf_button_image, bool righthalf_button_active)
{
  TFT_FillRect_Offset(HEAD_RIGHTHALF_BUTTON, HEAD_RIGHTHALF_BUTTON.color, 0, 0);
  if (righthalf_button_image != NO_IMAGE)
    GUI_DrawImageInRectCenterSwapColor(righthalf_button_image, HEAD_RIGHTHALF_BUTTON, TEMPLATE_COLOR, HEAD_RIGHTHALF_BUTTON.color);
  if (!righthalf_button_active)
    TFT_GrayoutRect_(HEAD_RIGHTHALF_BUTTON, BACKGROUND_COLOR);
}

void GUI_DrawHeaderMiddleleftButton(Int8U middleleft_button_image, bool middleleft_button_active)
{
  TFT_FillRect_Offset(HEAD_MIDDLELEFT_BUTTON, HEAD_MIDDLELEFT_BUTTON.color, 0, 0);
  if (middleleft_button_image != NO_IMAGE)
    GUI_DrawImageInRectCenterSwapColor(middleleft_button_image, HEAD_MIDDLELEFT_BUTTON, TEMPLATE_COLOR, HEAD_MIDDLELEFT_BUTTON.color);
  if (!middleleft_button_active)
    TFT_GrayoutRect_(HEAD_MIDDLELEFT_BUTTON, BACKGROUND_COLOR);
}
...
{
  if ((leftmost_button_image != NO_IMAGE) && (middleleft_button_image != NO_IMAGE))
  {
    GUI_DrawHeaderLeftmostButton(leftmost_button_image, leftmost_button_active);
    GUI_DrawHeaderMiddleleftButton(middleleft_button_image, middleleft_button_active);
  }
  else
  {
    GUI_DrawHeaderLefthalfButton(leftmost_button_image, leftmost_button_active);
  }
}

void GUI_DrawHeaderMiddlerightButton(Int8U middleright_button_image, bool middleright_button_active)
{
  TFT_FillRect_Offset(HEAD_MIDDLERIGHT_BUTTON, HEAD_MIDDLERIGHT_BUTTON.color, 0, 0);
  if (middleright_button_image != NO_IMAGE)
    GUI_DrawImageInRectCenterSwapColor(middleright_button_image, HEAD_MIDDLERIGHT_BUTTON, TEMPLATE_COLOR, HEAD_MIDDLERIGHT_BUTTON.color);
  if (!middleright_button_active)
    TFT_GrayoutRect_(HEAD_MIDDLERIGHT_BUTTON, BACKGROUND_COLOR);
}

void GUI_DrawHeaderRightmostButton(Int8U rightmost_button_image, bool rightmost_button_active)
{
  TFT_FillRect_Offset(HEAD_RIGHTMOST_BUTTON, HEAD_RIGHTMOST_BUTTON.color, 0, 0);
  if (rightmost_button_image != NO_IMAGE)
    GUI_DrawImageInRectCenterSwapColor(rightmost_button_image, HEAD_RIGHTMOST_BUTTON, TEMPLATE_COLOR, HEAD_RIGHTMOST_BUTTON.color);
  if (!rightmost_button_active)
    TFT_GrayoutRect_(HEAD_RIGHTMOST_BUTTON, BACKGROUND_COLOR);
}
...
{
  GUI_DrawHeaderMiddlerightButton(middleright_button_image, middleright_button_active);
  GUI_DrawHeaderRightmostButton(rightmost_button_image, rightmost_button_active);
}
...
void GUI_DrawMeasuresAll()
{
  char display[35];
  Int8U channels_count = GetDisplayChannelsCount();
  sprintf(display, "Канал %d - %d", CurrentMeasuresPage*4+1,  CurrentMeasuresPage*4+4);
  GUI_DrawHeader4B(SETTINGS_60x60, true, CONTROL_SCREEN_60x60, true, BACKWARD_60x60, (CurrentMeasuresPage > 0), FORWARD_60x60, ((CurrentMeasuresPage+1)*4 < channels_count), "Измерение", display);
...
{
  if (TFT_CoordsInRect(X, Y, HEAD_LEFTMOST_BUTTON))
  {
    set_sound(S_SOUND_20);
  ...
  if (TFT_CoordsInRect(X, Y, HEAD_MIDDLELEFT_BUTTON))
  {
    set_sound(S_SOUND_20);
  ...
  if (channels_count > 4)
  {
    if (TFT_CoordsInRect(X, Y, HEAD_RIGHTMOST_BUTTON) && ((CurrentMeasuresPage+1)*4 < channels_count))
    {
      set_sound(S_SOUND_20);
      CurrentMeasuresPage++;
      GUI_DrawMeasuresAll();
    ...
    if (TFT_CoordsInRect(X, Y, HEAD_MIDDLERIGHT_BUTTON) && (CurrentMeasuresPage > 0))
    {
      set_sound(S_SOUND_20);
      CurrentMeasuresPage--;
      GUI_DrawMeasuresAll();
...
void GUI_DrawMeasuresChannel()
{
  ...
  GUI_DrawHeader4B(SETTINGS_CHANNEL_60x60, true, CONTROL_SCREEN_60x60, true, BACKWARD_60x60, (CurrentDisplay != 0), FORWARD_60x60, (CurrentDisplay < channels_count - 1), "Измерение", display);
  
  int first, second;
  Int16U font_color, color;
  color = (*BORDER_BUTTONS_UD[CurrentDisplay-CurrentMeasuresPage*4]).color;
  for (int i = CurrentMeasuresPage*4; i < CurrentMeasuresPage*4+4; i++)
  {
    if (CurrentDisplay == i)
    {
...
void GUI_TouchMeasuresChannel(Int16U X, Int16U Y)
{
  ...
  if (CurrentDisplay > 0)
  {
    if (TFT_CoordsInRect(X, Y, HEAD_MIDDLERIGHT_BUTTON))
    {
      set_sound(S_SOUND_20);
      CurrentDisplay--;
  ...
  {
    if (TFT_CoordsInRect(X, Y, HEAD_RIGHTMOST_BUTTON))
    {
      set_sound(S_SOUND_20);
      CurrentDisplay++;
      CurrentMeasuresPage = CurrentDisplay / 4;
...
{
  GUI_DrawHeader2B(SETTINGS_60x60, true, CONTROL_SCREEN_60x60, true, "Измерение", "Канал 1");
  ...
  TFT_FillRect(LEFT_COLUMN_SX, LEFT_COLUMN_EX, UPPER_LINE_SY, LOWERMOST_LINE_EY, EVEN_YELLOW);
...
void GUI_DrawChannelSettingsRootScreen()
{
  char display[32];
  sprintf(display, "Канал %d", CurrentDisplay+1);
  GUI_DrawHeaderWide(BACK_60x60, true, NO_IMAGE, false, "Настройки", display);
...
void GUI_DrawChannelSettingsDisplayScreen()
{
  ...
  GUI_DrawHeader2B(OK_60x60, true, CANCEL_60x60, true, "Настройки", display);
...
{
  char display[30];
  sprintf(display, "Канал %d: %s", CurrentDisplay+1, PARAM_TYPES[MeasureAttribute[CurrentParam].ParamType]);
  GUI_DrawHeaderWide(SETTINGS_PARAM_60x60, true, NO_IMAGE, false, "Измерение", display);
  ...
  TFT_FillRect_(ULBUTTON, EVEN_YELLOW);
  TFT_FillRect_(MLBUTTON, EVEN_YELLOW);
  TFT_FillRect_(LLBUTTON, EVEN_YELLOW);
  TFT_FillRect_(LMLBUTTON, EVEN_YELLOW);
  ...
  if (BackToAllChannels) // пользователь зашёл из общего экрана
  {
    ...
    if ((first != -1) && (second != -1))
    {
      ...
      if (CurrentParam == first)
      {
        ...
        GetMeasureStringNoUnits(CurrentDisplay, first, value, &color);
      ...
      {
        back_color = first_param_rect->color;
        GetMeasureStringNoUnits(CurrentDisplay, second, value, &color);
...
void GUI_DrawParamThreshAndConstScreen()
{
  ...
  Int8U channels_count = GetDisplayChannelsCount();
  Int8U params_count = GetDisplayChannelParamsCount(CurrentDisplay);
  GUI_DrawHeader4B(BACK_60x60, true, NO_IMAGE, false, BACKWARD_60x60, !((CurrentDisplay == 0) && (CurrentParam == 0)), FORWARD_60x60, !((CurrentDisplay == channels_count-1) && (CurrentParam == params_count-1)), "Измерение", display);
...
{
  Int8U channels_count = GetOutChannelsCount();
  
  if (channels_count > 8)
  {
    GUI_DrawHeader4B(SWITCH_60x60, true, MEASURE_SCREEN_60x60, true, BACKWARD_60x60, (CurrentControlsPage == 1), FORWARD_60x60, (CurrentControlsPage == 0), "Управление", (CurrentControlsPage == 0) ? "Каналы 1 - 8" : "Каналы 9 - 16");
  }
  if (channels_count <= 8)
  {
    GUI_DrawHeader2B(SWITCH_60x60, true, MEASURE_SCREEN_60x60, true, "Управление", "Все каналы");
  }
...
void GUI_DrawControlScreen()
{
  ...
  GUI_DrawHeader4B(SETTINGS_CURRENT_60x60, true, CANCEL_60x60, true, BACKWARD_60x60, CurrentControl > 0, FORWARD_60x60, CurrentControl < 15, "Управление", display);
...
void GUI_UpdateControlCurrentManualScreen()
{
  ...
  //TFT_WriteStringInRectCenter(display, BROWN, EVEN_BLUE, RIGHTHALF_MIDDLE_BOTTOM, 0, 0, &Tahoma34);
  TFT_SmartWriteStringInRectCenter(display, BROWN, EVEN_BLUE, (RECT*)&RIGHTHALF_MIDDLE_BOTTOM, &Tahoma34);
...
void GUI_DrawRelayConfigurationCommonScreen()
{
  ...
  GUI_DrawHeader4B(OK_60x60, ok_active, CANCEL_60x60, true, BACKWARD_60x60, false, FORWARD_60x60, forward_active, "Настройки", display);
...
void GUI_ManualUpdateRelayConfigurationCommonScreen()
{
  ...
  {
    GUI_DrawHeaderLeftmostButton(OK_60x60, true);
    TFT_GrayoutRect_(HEAD_RIGHTMOST_BUTTON, BACKGROUND_COLOR);
    TFT_FillRect_(MIDDLE, BACKGROUND_COLOR);
  ...
  {
    TFT_GrayoutRect_(HEAD_LEFTMOST_BUTTON, BACKGROUND_COLOR);
    GUI_DrawHeaderRightmostButton(FORWARD_60x60, true);
...
void GUI_DrawRelayConfigurationLogicScreen()
{
  char display[32];
  sprintf(display, "Канал %d (реле)", CurrentControl+1);
  GUI_DrawHeader4B(OK_60x60, true, CANCEL_60x60, true, BACKWARD_60x60, true, FORWARD_60x60, false, "Настройки", display);
...
void GUI_DrawRelayConfigurationHesterScreen()
{
  char display[32];
  sprintf(display, "Канал %d (реле)", CurrentControl+1);
  GUI_DrawHeader4B(OK_60x60, !OutConfig[CurrentControl].ProgUse, CANCEL_60x60, true, BACKWARD_60x60, true, FORWARD_60x60, OutConfig[CurrentControl].ProgUse, "Настройки", display);
...
void GUI_DrawProgrammStepScreen()
{
  ...
  GUI_DrawHeader4B(OK_60x60, true, CANCEL_60x60, true, BACKWARD_60x60, CurrentProgrammStep > 0, FORWARD_60x60, CurrentProgrammStep < 511, "Настройки", display);
...
void GUI_ManualUpdateProgrammStepScreen()
{
  ...
  GUI_DrawHeaderRightButtons(BACKWARD_60x60, CurrentProgrammStep > 0, FORWARD_60x60, CurrentProgrammStep < 511);
...
{
  GUI_DrawHeaderWide(BACK_60x60, true, NO_IMAGE, false, "Настройки", "Меню настроек");
...
{
  GUI_DrawHeaderWide(BACK_60x60, true, NO_IMAGE, false, "Настройки", "Информация о приборе");
...
{
  char display[36];
  GUI_DrawHeaderWide(BACK_60x60, true, NO_IMAGE, false, "Настройки", "Настройки связи");
...
{
  GUI_DrawHeader2B(OK_60x60, true, CANCEL_60x60, true, "Настройки", "RS-232 и RS-485");
...
{
  GUI_DrawHeaderWide(BACK_60x60, true, NO_IMAGE, false, "Настройки", "TCP/IP и UDP/IP");
...
void GUI_UpdateSettingsTCPScreen()
{
  ...
  TFT_SmartWriteStringInRectCenter(ip, DARKGREEN, BACKGROUND_COLOR, (RECT*)&RIGHTHALF_MIDDLE, &Tahoma34);
  TFT_UnderlineRect_Offset(MIDDLE, BLACK, 1, 40, 0);
  
  //TFT_FillRect_(RIGHTHALF_LOWER, BACKGROUND_COLOR);
  //TFT_WriteStringInRectCenter(mask, color, BACKGROUND_COLOR, RIGHTHALF_LOWER, 0, 0, &Tahoma34);
  TFT_SmartWriteStringInRectCenter(mask, DARKGREEN, BACKGROUND_COLOR, (RECT*)&RIGHTHALF_LOWER, &Tahoma34);
  TFT_UnderlineRect_Offset(LOWER, BLACK, 1, 40, 0);
  ...
  TFT_SmartWriteStringInRectCenter(gate, DARKGREEN, BACKGROUND_COLOR, (RECT*)&RIGHTHALF_LOWERMOST, &Tahoma34);
}
...
{
  GUI_DrawHeaderWide(BACK_60x60, true, NO_IMAGE, false, "Настройки", "Статистика");
...
{
  GUI_DrawHeader4B(BACK_60x60, true, NO_IMAGE, false, BACKWARD_60x60, false, FORWARD_60x60, true, "Настройки", "Другие настройки");
...
{
  GUI_DrawHeader4B(BACK_60x60, true, NO_IMAGE, false, BACKWARD_60x60, true, FORWARD_60x60, false, "Настройки", "Другие настройки");
...
{
  GUI_DrawHeader4B(OK_60x60, false, CANCEL_60x60, true, BACKWARD_60x60, false, FORWARD_60x60, true, "Настройки", "Дата");
...
{
  GUI_DrawHeader4B(OK_60x60, true, CANCEL_60x60, true, BACKWARD_60x60, true, FORWARD_60x60, false, "Настройки", "Время");
...
{
  GUI_DrawHeader2B(OK_60x60, true, CANCEL_60x60, true, "Настройки", "Звуки");
...
{
  char display[32];
  GUI_DrawHeader2B(OK_60x60, true, CANCEL_60x60, true, "Настройки", "Веб-интерфейс");
...
{   
  ...
  OS_Delay (101);                             //  Delay for PLL stable  
